  ...
  return (
    <nav className="sticky top-0 z-50 flex items-center justify-between px-8 h-16 bg-brand-black/95 backdrop-blur-sm border-b border-brand-border">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          onClick={toggle}
          className="flex items-center gap-0.5 border border-brand-border rounded overflow-hidden"
        >
        ...
        {/* Live button */}
        <Link to="/live" className="flex items-center gap-1.5 bg-brand-red text-white px-3.5 py-1.5 rounded text-xs font-ui font-bold uppercase tracking-wider">
