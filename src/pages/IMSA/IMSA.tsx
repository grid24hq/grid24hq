...
const TEAMS: Team[] = [
  ...
  { id: 'cadillac-wayne-taylor-racing-no10',                nr: 10,  klasse: 'GTP',     merk: 'Cadillac',    auto: 'Cadillac V-Series.R', team: 'Cadillac Wayne Taylor Racing',          drivers: ['FilipeAlbuquerque','RickyTaylor','WillStevens'],                          land: 'us' },
