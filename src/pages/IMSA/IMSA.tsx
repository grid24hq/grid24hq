...
const TEAMS: Team[] = [
  ...
  { id: 'pratt-miller-motorsports-no-73',                   nr: 73,  klasse: 'GTP',     merk: 'Corvette',    auto: 'Chevrolet Corvette Z06R GT3', team: 'Pratt Miller Motorsports',     drivers: ['ChrisCumming','EnzoFittipaldi','ManuelEspiritoSanto','PietroFittipaldi'],land: 'us' },
  { id: 'whelen-engineering-racing-no-31',                  nr: 31,  klasse: 'GTP',     merk: 'Cadillac',    auto: 'Cadillac V-LMDh',     team: 'Whelen Engineering Racing',             drivers: ['ConnorZilisch','EarlBamber','FrederikVesti','JackAitken'],               land: 'us' },
  ...
  { id: 'pr1-mathiasen-motorsports-no-52',                  nr: 52,  klasse: 'LMP2',    merk: 'ORECA',       auto: 'ORECA 07 Gibson',     team: 'PR1 Mathiasen Motorsports',             drivers: ['BenKeating','HarryTincknell','MishaGoikhberg','ParkerThompson'],         land: 'us' },
  ...
  // ── GTD PRO ───────────────────────────────────────────────────────────────
  { id: 'af-corse-no-83',                                   nr: 83,  klasse: 'GTD_PRO', merk: 'Ferrari',     auto: 'Ferrari 296 GT3',     team: 'AF Corse',                              drivers: ['DylanMurr','FrancoisPerrodo','MatthieuVaxiviere','NicklasNielsen'],      land: 'it' },
  { id: 'ford-multimatic-motorsports-no-64',                nr: 64,  klasse: 'GTD_PRO', merk: 'Ford',        auto: 'Ford Mustang GT3',    team: 'Ford Multimatic Motorsports',           drivers: ['BenBarker','DennisOlsen','MikeRockenfeller'],                            land: 'us' },
  { id: 'ford-multimatic-motorsports-no-65',                nr: 65,  klasse: 'GTD_PRO', merk: 'Ford',        auto: 'Ford Mustang GT3',    team: 'Ford Multimatic Motorsports',           drivers: ['ChristopherMies','FredericVervisch','SebastianPraulx'],                  land: 'us' },
  ...
  { id: 'manthey-no-911',                                   nr: 911, klasse: 'GTD_PRO', merk: 'Porsche',     auto: 'Porsche 911 GT3 R',   team: 'Manthey',                               drivers: ['AyhancanGuven','KlausBachler','RicardoFeller','ThomasPreining'],          land: 'de' },
  { id: 'pfaff-motorsports-no-9',                           nr: 9,   klasse: 'GTD_PRO', merk: 'Lamborghini', auto: 'Lamborghini Huracán GT3', team: 'Pfaff Motorsports',                 drivers: ['AndreaCaldarelli','JamesHinchcliffe','MirkoBortolotti','SandyMitchell'], land: 'ca' },
  { id: 'risi-competizione-no-62',                          nr: 62,  klasse: 'GTD_PRO', merk: 'Ferrari',     auto: 'Ferrari 296 GT3',     team: 'Risi Competizione',                     drivers: ['AlessandroPierGuidi','DanielSerra','DavideRigon'],                       land: 'it' },
  { id: 'rll-team-mclaren-no-59',                           nr: 59,  klasse: 'GTD_PRO', merk: 'McLaren',     auto: 'McLaren 720S GT3',    team: 'RLL Team McLaren',                      drivers: ['DeanMacDonald','JuirVips','MaxEsterson','NikitaJohnson'],                land: 'gb' },
  { id: 'sun-energy-1-no-75',                               nr: 75,  klasse: 'GTD_PRO', merk: 'Mercedes',    auto: 'Mercedes-AMG GT3',    team: 'Sun Energy 1',                          drivers: ['ChazMostert','KennyHabul','MaroEngel','WillPower'],                      land: 'us' },
