...
const TEAMS: Team[] = [
  // ── GTP ──────────────────────────────────────────────────────────────────
  // ── GTP ───────────────────────────────────────────────────────────────────
  { id: 'acura-meyer-shank-racing-w-curb-agajanian-no-60',  nr: 60,  klasse: 'GTP',     merk: 'Acura',       auto: 'Acura ARX-06',        team: 'Acura Meyer Shank Racing',              drivers: ['ColinBraun','ScottDixon','TomBlomqvist'],                                land: 'us' },
  { id: 'acura-meyer-shank-racing-w-curb-agajanian-no-93',  nr: 93,  klasse: 'GTP',     merk: 'Acura',       auto: 'Acura ARX-06',        team: 'Acura Meyer Shank Racing',              drivers: ['AlexPalou','KakuOhta','NickYelloly','RengervanderZande'],                land: 'us' },
  { id: 'aston-martin-thor-team-no-23',                     nr: 23,  klasse: 'GTP',     merk: 'Aston',       auto: 'Aston Martin Valkyrie', team: 'Aston Martin THOR Team',             drivers: ['AlexRiberas','MarcoSorensen','RomanDeAngelis','RossGunn'],               land: 'gb' },
  { id: 'bmw-team-rll-no-24',                               nr: 24,  klasse: 'GTP',     merk: 'BMW',         auto: 'BMW M Hybrid V8',     team: 'BMW M Team WRT',                        drivers: ['DriesVanthoor','ReneRast','RobinFrijns','SheldonvanderLinde'],            land: 'de' },
  { id: 'bmw-team-rll-no-25',                               nr: 25,  klasse: 'GTP',     merk: 'BMW',         auto: 'BMW M Hybrid V8',     team: 'BMW M Team WRT',                        drivers: ['KevinMagnussen','MarcoWittmann','PhilippEng','RaffaeleMarciello'],        land: 'de' },
  { id: 'cadillac-wayne-taylor-racing-no-10',                nr: 10,  klasse: 'GTP',     merk: 'Cadillac',    auto: 'Cadillac V-Series.R', team: 'Cadillac Wayne Taylor Racing',          drivers: ['FilipeAlbuquerque','RickyTaylor','WillStevens'],                          land: 'us' },
  { id: 'cadillac-wayne-taylor-racing-no-40',               nr: 40,  klasse: 'GTP',     merk: 'Cadillac',    auto: 'Cadillac V-Series.R', team: 'Cadillac Wayne Taylor Racing',          drivers: ['ColtonHerta','JordanTaylor','LouisDeletraz'],                             land: 'us' },
  { id: 'corvette-racing-no-3',                             nr: 3,   klasse: 'GTP',     merk: 'Chevrolet',   auto: 'Chevrolet Corvette Z06R', team: 'Corvette Racing by Pratt Miller',    drivers: ['AntonioGarcia','MarvinKirchhofer'],                                       land: 'us' },
  { id: 'corvette-racing-no-4',                             nr: 4,   klasse: 'GTP',     merk: 'Chevrolet',   auto: 'Chevrolet Corvette Z06R', team: 'Corvette Racing by Pratt Miller',    drivers: ['NickyCatsburg','NicoVarrone','TommyMilner'],                              land: 'us' },
  { id: 'jdc-miller-motorsports-no-85',                     nr: 5,   klasse: 'GTP',     merk: 'Porsche',     auto: 'Porsche 963',         team: 'JDC-Miller MotorSports',                drivers: ['KaylenFrederick','NicoPino','TijmenvanderHelm'],                          land: 'us' },
  { id: 'porsche-penske-motorsport-no-6',                   nr: 6,   klasse: 'GTP',     merk: 'Porsche',     auto: 'Porsche 963',         team: 'Porsche Penske Motorsport',             drivers: ['LaurensVanthoor','MattCampbell'],                                         land: 'de' },
  { id: 'porsche-penske-motorsport-no-7',                   nr: 7,   klasse: 'GTP',     merk: 'Porsche',     auto: 'Porsche 963',         team: 'Porsche Penske Motorsport',             drivers: ['JulienAndlauer','LaurinHeinrich'],                                        land: 'de' },
  { id: 'whelen-engineering-racing-no-31',                  nr: 31,  klasse: 'GTP',     merk: 'Cadillac',    auto: 'Cadillac V-Series.R', team: 'Cadillac Whelen',                       drivers: ['EarlBamber','FrederikVesti','JackAitken'],                                land: 'us' },

  // ── LMP2 ──────────────────────────────────────────────────────────────────
  { id: 'crowdstrike-racing-by-apr-04',                     nr: 4,   klasse: 'LMP2',    merk: 'ORECA',       auto: 'ORECA 07 Gibson',     team: 'CrowdStrike Racing by APR',             drivers: ['GeorgeKurtz','MaltheJakobsen','TobySowery'],                              land: 'us' },
  ...
  { id: 'inter-europol-competition-no-343',                 nr: 343, klasse: 'LMP2',    merk: 'ORECA',       auto: 'ORECA 07 Gibson',     team: 'Inter Europol Competition',             drivers: ['GeorgeKolovos','JakubSmiechowski','NolanSiegel'],                         land: 'pl' },
  { id: 'inter-europol-competition-no-43',                  nr: 43,  klasse: 'LMP2',    merk: 'ORECA',       auto: 'ORECA 07 Gibson',     team: 'Inter Europol Competition',             drivers: ['BijoyGarg','JeremyClarke','TomDillman'],                                  land: 'pl' },
  { id: 'intersport-racing-no-37',                          nr: 37,  klasse: 'LMP2',    merk: 'ORECA',       auto: 'ORECA 07 Gibson',     team: 'Intersport Racing',                     drivers: ['JobVanUitert','JonField','SethLucas'],                                    land: 'us' },
  { id: 'pr1-mathiasen-motorsports-no-52',                  nr: 52,  klasse: 'LMP2',    merk: 'ORECA',       auto: 'ORECA 07 Gibson',     team: 'Bryan Herta Autosport with PR1/Mathiasen', drivers: ['HarryTincknell','MishaGoikhberg','ParkerThompson'],               land: 'us' },
  ...
  { id: 'tower-motorsport-no-8',                            nr: 8,   klasse: 'LMP2',    merk: 'ORECA',       auto: 'ORECA 07 Gibson',     team: 'Tower Motorsport',                      drivers: ['KyffinSimpson','SebastianAlvarez','SebastienBourdais'],                  land: 'us' },
  { id: 'united-autosports-usa-no-2',                       nr: 2,   klasse: 'LMP2',    merk: 'ORECA',       auto: 'ORECA 07 Gibson',     team: 'United Autosports USA',                 drivers: ['HunterMcElrea','MikkelJensen','PhilFayer'],                               land: 'gb' },
  { id: 'united-autosports-no-22',                          nr: 22,  klasse: 'LMP2',    merk: 'ORECA',       auto: 'ORECA 07 Gibson',     team: 'United Autosports USA',                 drivers: ['GregoireSaucy','PaulDiResta','RasmusLindh'],                              land: 'gb' },
 ...
 // ── GTD PRO ───────────────────────────────────────────────────────────────
  { id: 'af-corse-no-83',                                   nr: 83,  klasse: 'GTD_PRO', merk: 'Ferrari',     auto: 'Ferrari 296 GT3',     team: 'AF Corse USA',                          drivers: ['DylanMurr','FrancoisPerrodo','MatthieuVaxiviere','NicklasNielsen'],      land: 'it' },
  ...
  { id: 'ford-multimatic-motorsports-no-64',                nr: 64,  klasse: 'GTD_PRO', merk: 'Ford',        auto: 'Ford Mustang GT3',    team: 'Ford Racing',                           drivers: ['DennisOlsen','MikeRockenfeller'],                                         land: 'us' },
  { id: 'ford-multimatic-motorsports-no-65',                nr: 65,  klasse: 'GTD_PRO', merk: 'Ford',        auto: 'Ford Mustang GT3',    team: 'Ford Racing',                           drivers: ['FredericVervisch','SebastianPraulx'],                                     land: 'us' },
  { id: 'getspeed-no-69',                                   nr: 69,  klasse: 'GTD_PRO', merk: 'Mercedes',    auto: 'Mercedes-AMG GT3',    team: 'GetSpeed',                              drivers: ['FabianSchiller','JulesGounon','MaximilianGoetz'],                         land: 'de' },
  { id: 'heart-of-racing-team-no-27',                       nr: 27,  klasse: 'GTD_PRO', merk: 'Aston',       auto: 'Aston Martin Vantage GT3', team: 'Heart of Racing Team',            drivers: ['MattiaDrudi','TomGamble','ZacharieRobichon'],                             land: 'us' },
  { id: 'manthey-no-911',                                   nr: 911, klasse: 'GTD_PRO', merk: 'Porsche',     auto: 'Porsche 911 GT3 R',   team: 'Manthey',                               drivers: ['AyhancanGuven','KlausBachler','ThomasPreining'],                          land: 'de' },
  { id: 'paul-miller-racing-no-1',                          nr: 1,   klasse: 'GTD_PRO', merk: 'BMW',         auto: 'BMW M4 GT3 Evo',      team: 'Paul Miller Racing',                    drivers: ['DanHarper','MaxHesse','NeilVerhagen'],                                    land: 'us' },
  { id: 'pfaff-motorsports-no-9',                           nr: 9,   klasse: 'GTD_PRO', merk: 'Lamborghini', auto: 'Lamborghini Huracán GT3 Evo 2', team: 'Pfaff Motorsports',           drivers: ['JamesHinchcliffe','MirkoBortolotti','SandyMitchell'],                    land: 'ca' },
  { id: 'risi-competizione-no-62',                          nr: 62,  klasse: 'GTD_PRO', merk: 'Ferrari',     auto: 'Ferrari 296 GT3',     team: 'Risi Competizione',                     drivers: ['DanielSerra','DavideRigon'],                                              land: 'it' },
  { id: 'rll-team-mclaren-no-59',                           nr: 59,  klasse: 'GTD_PRO', merk: 'McLaren',     auto: 'McLaren 720S GT3 Evo', team: 'RLL Team McLaren',                     drivers: ['JuirVips','MaxEsterson','NikitaJohnson'],                                 land: 'gb' },
  { id: 'sun-energy-1-no-75',                               nr: 75,  klasse: 'GTD_PRO', merk: 'Mercedes',    auto: 'Mercedes-AMG GT3',    team: '75 Express',                            drivers: ['KennyHabul','MaroEngel','WillPower'],                                     land: 'us' },
  { id: 'triarsi-competizione-no-023',                      nr: 33,  klasse: 'GTD_PRO', merk: 'Ferrari',     auto: 'Ferrari 296 GT3',     team: 'Triarsi Competizione',                  drivers: ['OnofrioTriarsi','RobertMegennis','YifeiYe'],                              land: 'it' },
  { id: 'winward-racing-no-48',                             nr: 48,  klasse: 'GTD_PRO', merk: 'Mercedes',    auto: 'Mercedes-AMG GT3',    team: 'Winward Racing',                        drivers: ['JasonHart','MaximiMartin'],                                               land: 'us' },

  // ── GTD ───────────────────────────────────────────────────────────────────
  { id: 'af-corse-no-21',                                   nr: 21,  klasse: 'GTD',     merk: 'Ferrari',     auto: 'Ferrari 296 GT3',     team: 'AF Corse',                              drivers: ['AntonioFuoco','LilouWadoux','SimonMann','TommasoMosca'],                 land: 'it' },
  { id: 'ao-racing-no-77',                                  nr: 77,  klasse: 'GTD',     merk: 'Lamborghini', auto: 'Lamborghini Huracán GT3', team: 'AO Racing',                          drivers: ['AlessioPicariello','HarryKing','NickTandy'],                             land: 'us' },
  { id: 'ao-racing-no-99',                                  nr: 99,  klasse: 'GTD',     merk: 'Lamborghini', auto: 'Lamborghini Huracán GT3', team: 'AO Racing',                          drivers: ['ChristianRasmussen','DaneCameron','JonnyEdgar','PJHyett'],               land: 'us' },
  { id: 'aston-martin-thor-team-no-23',                     nr: 23,  klasse: 'GTD',     merk: 'Aston',       auto: 'Aston Martin Vantage GT3', team: 'Aston Martin Thor Team',           drivers: ['AlexRiberas','MarcoSorensen','RomanDeAngelis','RossGunn'],               land: 'gb' },
  { id: 'awa-no-13',                                        nr: 13,  klasse: 'GTD',     merk: 'Ferrari',     auto: 'Ferrari 296 GT3',     team: 'AWA',                                   drivers: ['BenGreen','LarsKern','MatthewBell','OreyFidani'],                        land: 'us' },
  { id: 'conquest-racing-no-34',                            nr: 34,  klasse: 'GTD',     merk: 'Lamborghini', auto: 'Lamborghini Huracán GT3', team: 'Conquest Racing',                    drivers: ['AlbertCosta','LorenzoPatrese','MannyFranco','ThierryVermeulen'],          land: 'us' },
  { id: 'crowdstrike-racing-by-apr-04',                     nr: 4,   klasse: 'GTD',     merk: 'Porsche',     auto: 'Porsche 911 GT3 R',   team: 'CrowdStrike Racing by APR',             drivers: ['AlexQuinn','GeorgeKurtz','MaltheJakobsen','TobySowery'],                 land: 'us' },
  { id: 'dragonspeed-no-81',                                nr: 81,  klasse: 'GTD',     merk: 'Ferrari',     auto: 'Ferrari 296 GT3',     team: 'DragonSpeed',                           drivers: ['CasperStevenson','GIacomoAltoe','HenrickHedman','MatteoCairoli'],        land: 'us' },
  { id: 'dxdt-racing-no-36',                                nr: 36,  klasse: 'GTD',     merk: 'Mercedes',    auto: 'Mercedes-AMG GT3',    team: 'DXDT Racing',                           drivers: ['CharlieEastwood','MasonFilippi','SalihYoluc','ScottMcLaughlin'],         land: 'us' },
  { id: 'getspeed-no-69',                                   nr: 69,  klasse: 'GTD',     merk: 'Mercedes',    auto: 'Mercedes-AMG GT3',    team: 'GetSpeed',                              drivers: ['AnthonyBartone','FabianSchiller','JulesGounon','MaximilianGoetz'],       land: 'de' },
  { id: 'gradient-racing-no-66',                            nr: 66,  klasse: 'GTD',     merk: 'Acura',       auto: 'Acura NSX GT3',       team: 'Gradient Racing',                       drivers: ['TillBechtolsheimer','CoreyLewis','JakeWalker','JoeyHand'],               land: 'us' },
  { id: 'inception-racing-no-70',                           nr: 70,  klasse: 'GTD',     merk: 'McLaren',     auto: 'McLaren 720S GT3',    team: 'Inception Racing',                      drivers: ['BrendanIribe','DavidFumanelli','FrederikSchandorff','OllieMillroy'],     land: 'gb' },
  { id: 'intersport-racing-no-37',                          nr: 37,  klasse: 'GTD',     merk: 'Lamborghini', auto: 'Lamborghini Huracán GT3', team: 'Intersport Racing',                  drivers: ['JobVanUitert','JonField','OliverJarvis','SethLucas'],                    land: 'us' },
  { id: 'jdc-miller-motorsports-no-85',                     nr: 85,  klasse: 'GTD',     merk: 'Lamborghini', auto: 'Lamborghini Huracán GT3', team: 'JDC-Miller Motorsports',             drivers: ['KaylenFrederick','NicoPino','TijmenvanderHelm'],                          land: 'us' },
  { id: 'lone-star-racing-no-80',                           nr: 80,  klasse: 'GTD',     merk: 'Ferrari',     auto: 'Ferrari 296 GT3',     team: 'Lone Star Racing',                      drivers: ['JamesRoe','LinHodenius','RalfAron','ScottAndrews'],                      land: 'us' },
  { id: 'magnus-racing-no-44',                              nr: 44,  klasse: 'GTD',     merk: 'Porsche',     auto: 'Porsche 911 GT3 R',   team: 'Magnus Racing',                         drivers: ['JohnPotter','MadisonSnow','NickiThiim','SpencerPumpelly'],               land: 'us' },
  ...
  { id: 'muehlner-motorsports-america-no-123',              nr: 123, klasse: 'GTD',     merk: 'Porsche',     auto: 'Porsche 911 GT3 R',   team: 'Muehlner Motorsports America',          drivers: ['DaveMusial','DaveMusialJr','PeterLudwig','RyanYardley'],                  land: 'us' },
  { id: 'myers-riley-motorsports-no-16',                    nr: 16,  klasse: 'GTD',     merk: 'Lamborghini', auto: 'Lamborghini Huracán GT3', team: 'Myers Riley Motorsports',            drivers: ['FelipeFraga','JensonAltzman','RomainGrosjean','SheenaMonk'],              land: 'us' },
  { id: 'paul-miller-racing-no-1',                          nr: 1,   klasse: 'GTD',     merk: 'Lamborghini', auto: 'Lamborghini Huracán GT3', team: 'Paul Miller Racing',                 drivers: ['ConnorDePhillippi','DanHarper','MaxHesse','NeilVerhagen'],                land: 'us' },
  { id: 'rs1-no-28-iwsc',                                   nr: 28,  klasse: 'GTD',     merk: 'Porsche',     auto: 'Porsche 911 GT3 R',   team: 'RS1',                                   drivers: ['DillonMachavern','EricZitza','JanHeylen','SvenMuller'],                   land: 'us' },
  { id: 'tds-racing-no-11',                                 nr: 11,  klasse: 'GTD',     merk: 'Lamborghini', auto: 'Lamborghini Huracán GT3', team: 'TDS Racing',                         drivers: ['CharlesMilesi','DavidHeinemeierHansson','MathiasBeche','TobiLutke'],      land: 'fr' },
  { id: 'triarsi-competizione-no-023',                      nr: 23,  klasse: 'GTD',     merk: 'Ferrari',     auto: 'Ferrari 296 GT3',     team: 'Triarsi Competizione',                  drivers: ['KentonKoch','OnofrioTriarsi','RobertMegennis','YifeiYe'],                land: 'it' },
  { id: 'turner-motorsport-no-96',                          nr: 96,  klasse: 'GTD',     merk: 'BMW',         auto: 'BMW M4 GT3',          team: 'Turner Motorsport',                     drivers: ['FrancisSelldorff','JensKlingmann','PatrickGallagher','RobbyFoley'],       land: 'us' },
  { id: 'united-autosports-no-22',                          nr: 22,  klasse: 'GTD',     merk: 'McLaren',     auto: 'McLaren 720S GT3',    team: 'United Autosports',                     drivers: ['DanGoldburg','GregoireSaucy','PaulDiResta','RasmusLindh'],                land: 'gb' },
  { id: 'van-der-steur-racing-no-19-2',                     nr: 19,  klasse: 'GTD',     merk: 'Ferrari',     auto: 'Ferrari 296 GT3',     team: 'Van der Steur Racing',                  drivers: ['CarlBennett','RoryvanderSteur','SebastienBaud','ValentinHasseClot'],      land: 'us' },
  { id: 'vasser-sullivan-no-12',                            nr: 12,  klasse: 'GTD',     merk: 'Lamborghini', auto: 'Lamborghini Huracán GT3', team: 'Vasser Sullivan',                    drivers: ['AaronTelitz','BenjaminPedersen','EstebanMasson'],                        land: 'us' },
  { id: 'vasser-sullivan-no-14',                            nr: 14,  klasse: 'GTD',     merk: 'Lamborghini', auto: 'Lamborghini Huracán GT3', team: 'Vasser Sullivan',                    drivers: ['BenBarnicoat','JackHawksworth','KyleKirkwood'],                           land: 'us' },
  { id: 'wayne-taylor-racing-no-45',                        nr: 45,  klasse: 'GTD',     merk: 'Lamborghini', auto: 'Lamborghini Huracán GT3', team: 'Wayne Taylor Racing',                drivers: ['DannyFormal','GrahamDoyle','MarcusEricsson','TrentHindman'],              land: 'us' },
  { id: 'winward-racing-no-48',                             nr: 48,  klasse: 'GTD',     merk: 'Mercedes',    auto: 'Mercedes-AMG GT3',    team: 'Winward Racing',                        drivers: ['JasonHart','LucaStolz','MaximiMartin'],                                   land: 'us' },
  { id: 'winward-racing-no-57',                             nr: 57,  klasse: 'GTD',     merk: 'Mercedes',    auto: 'Mercedes-AMG GT3',    team: 'Winward Racing',                        drivers: ['IndyDontje','LucasAuer','PhilipEllis','RussellWard'],                     land: 'us' },
