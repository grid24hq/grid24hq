...
const RIJDER_INFO: Record<string, RijderInfo> = {
  ...
  filippo_farioli:       { geboortedatum: '3 apr. 2003',   leeftijd: 22, geboorteplaats: 'Brescia, Italië',       lengte: '1.74 m', debuut: '2026, Phillip Island', wereldtitels: 0, bikeModel: 'YZF-R9',           motor: 'Yamaha I3',      omschrijving: 'Filippo Farioli is een jong Italiaans talent dat in 2026 zijn WorldSSP-debuut maakt bij VFT Racing.' },
  leonardo_taccini:      { geboortedatum: '16 sep. 2002',  leeftijd: 23, geboorteplaats: 'Imola, Italië',         lengte: '1.75 m', debuut: '2026, Phillip Island', wereldtitels: 0, bikeModel: 'Panigale V2',      motor: 'Ducati V2',      omschrijving: 'Leonardo Taccini is een Italiaans talent dat in 2026 rijdt voor Ecosantagata Althea Racing Team.' },
  matteo_ferrari:        { geboortedatum: '19 jan. 2000',  leeftijd: 25, geboorteplaats: 'Parma, Italië',        lengte: '1.76 m', debuut: '2026, Phillip Island', wereldtitels: 0, bikeModel: 'YZF-R9',           motor: 'Yamaha I3',      omschrijving: 'Matteo Ferrari is een Italiaans talent dat in 2026 rijdt voor WRP Racing in WorldSSP.' },
  andreas_kofler:        { geboortedatum: '5 mrt. 1999',   leeftijd: 26, geboorteplaats: 'Innsbruck, Oostenrijk', lengte: '1.78 m', debuut: '2026, Phillip Island', wereldtitels: 0, bikeModel: 'YZF-R9',           motor: 'Yamaha I3',      omschrijving: 'Andreas Kofler is een Oostenrijks talent dat in 2026 zijn WorldSSP-debuut maakt bij Motorsport Kofler.' },
  xavi_cardelus:         { geboortedatum: '25 aug. 1999',  leeftijd: 26, geboorteplaats: 'Andorra',              lengte: '1.73 m', debuut: '2021, Phillip Island', wereldtitels: 0, bikeModel: 'YZF-R9',           motor: 'Yamaha I3',      omschrijving: 'Xavi Cardelús is een rijder uit Andorra die in 2026 rijdt voor Cerba Yamaha Racing Team.' },
  oliver_konig:          { geboortedatum: '12 nov. 2000',  leeftijd: 25, geboorteplaats: 'Praag, Tsjechië',      lengte: '1.77 m', debuut: '2024, Phillip Island', wereldtitels: 0, bikeModel: 'ZX-6R',            motor: 'Kawasaki I4',    omschrijving: 'Oliver König is een Tsjechisch talent dat in 2026 rijdt voor Compos Racing Team.' },
  oli_bayliss:           { geboortedatum: '23 sep. 2003',  leeftijd: 22, geboorteplaats: 'Brisbane, Australië',  lengte: '1.76 m', debuut: '2023, Phillip Island', wereldtitels: 0, bikeModel: 'Triumph Street Triple RS', motor: 'Triumph I3', omschrijving: 'Oli Bayliss is de zoon van drievoudig WorldSBK-kampioen Troy Bayliss en rijdt in 2026 voor PTR Triumph.' },
  hector_garzo:          { geboortedatum: '25 sep. 1996',  leeftijd: 29, geboorteplaats: 'Valencia, Spanje',     lengte: '1.75 m', debuut: '2020, Phillip Island', wereldtitels: 0, bikeModel: 'Panigale V2',      motor: 'Ducati V2',      omschrijving: 'Héctor Garzó is een ervaren Spaanse rijder die in 2026 rijdt voor Renzi Corse in WorldSSP.' },
  ondrej_vostatek:       { geboortedatum: '8 mei 2000',    leeftijd: 25, geboorteplaats: 'Praag, Tsjechië',      lengte: '1.76 m', debuut: '2022, Phillip Island', wereldtitels: 0, bikeModel: 'ZX-6R',            motor: 'Kawasaki I4',    omschrijving: 'Ondrej Voštatek is een Tsjechisch talent dat in 2026 rijdt voor Compos Racing Team.' },
  petr_svoboda:          { geboortedatum: '20 feb. 1998',  leeftijd: 27, geboorteplaats: 'Brno, Tsjechië',       lengte: '1.79 m', debuut: '2026, Phillip Island', wereldtitels: 0, bikeModel: 'YZF-R9',           motor: 'Yamaha I3',      omschrijving: 'Petr Svoboda is een Tsjechisch talent dat in 2026 zijn WorldSSP-debuut maakt bij WRP Racing.' },
  tom_booth_amos:        { geboortedatum: '7 aug. 1998',   leeftijd: 27, geboorteplaats: 'Leicester, Engeland',  lengte: '1.80 m', debuut: '2023, Phillip Island', wereldtitels: 0, bikeModel: 'Triumph Street Triple RS', motor: 'Triumph I3', omschrijving: 'Tom Booth-Amos is een Brits talent dat in 2026 rijdt voor PTR Triumph Factory Racing.' },
  josh_whatley:          { geboortedatum: '12 jun. 2001',  leeftijd: 24, geboorteplaats: 'Devon, Engeland',      lengte: '1.77 m', debuut: '2025, Phillip Island', wereldtitels: 0, bikeModel: 'Panigale V2',      motor: 'Ducati V2',      omschrijving: 'Josh Whatley is een Brits talent dat in 2026 rijdt voor Orelac Racing Verdnatura.' },
  jacopo_cretaro:        { geboortedatum: '21 mrt. 1997',  leeftijd: 28, geboorteplaats: 'Varese, Italië',       lengte: '1.75 m', debuut: '2024, Phillip Island', wereldtitels: 0, bikeModel: 'MV Agusta F3',     motor: 'MV Agusta I3',   omschrijving: 'Jacopo Cretaro rijdt in 2026 op de MV Agusta F3 voor Flembbo by Racing Development.' },
...
const SSP_GRID = [
  ...
  { id: 'jaume_masia',         voornaam: 'Jaume',      naam: 'MASIÁ',          landCode: 'es', nummer: 5,  merk: 'Ducati',   team: 'Orelac Racing Verdnatura'                 },
  { id: 'corentin_perolari',   voornaam: 'Corentin',   naam: 'PEROLARI',       landCode: 'fr', nummer: 6,  merk: 'Honda',    team: 'Honda Racing World Supersport'            },
  { id: 'filippo_farioli',     voornaam: 'Filippo',    naam: 'FARIOLI',        landCode: 'it', nummer: 7,  merk: 'Yamaha',   team: 'VFT Racing Yamaha'                        },
  { id: 'leonardo_taccini',    voornaam: 'Leonardo',   naam: 'TACCINI',        landCode: 'it', nummer: 10, merk: 'Ducati',   team: 'Ecosantagata Althea Racing Team'          },
  { id: 'matteo_ferrari',      voornaam: 'Matteo',     naam: 'FERRARI',        landCode: 'it', nummer: 11, merk: 'Yamaha',   team: 'WRP Racing'                               },
  { id: 'alessandro_zaccone',  voornaam: 'Alessandro', naam: 'ZACCONE',        landCode: 'it', nummer: 16, merk: 'Ducati',   team: 'Ecosantagata Althea Racing Team'          },
  { id: 'andreas_kofler',      voornaam: 'Andreas',    naam: 'KOFLER',         landCode: 'at', nummer: 19, merk: 'Yamaha',   team: 'Motorsport Kofler'                        },
  { id: 'xavi_cardelus',       voornaam: 'Xavi',       naam: 'CARDELUS',       landCode: 'es', nummer: 20, merk: 'Yamaha',   team: 'Cerba Yamaha Racing Team'                 },
  { id: 'ana_carrasco',        voornaam: 'Ana',        naam: 'CARRASCO',       landCode: 'es', nummer: 22, merk: 'Honda',    team: 'Honda Racing World Supersport'            },
  { id: 'marcos_ramirez',      voornaam: 'Marcos',     naam: 'RAMÍREZ',        landCode: 'es', nummer: 24, merk: 'QJMOTOR',  team: 'QJMOTOR Factory Racing'                   },
  { id: 'oliver_konig',        voornaam: 'Oliver',     naam: 'KÖNIG',          landCode: 'cz', nummer: 25, merk: 'Kawasaki', team: 'Compos Racing Team'                       },
  { id: 'yuki_okamoto',        voornaam: 'Yuki',       naam: 'OKAMOTO',        landCode: 'jp', nummer: 31, merk: 'Yamaha',   team: 'Pata Yamaha Ten Kate Racing'              },
  { id: 'oli_bayliss',         voornaam: 'Oli',        naam: 'BAYLISS',        landCode: 'au', nummer: 32, merk: 'Triumph',  team: 'PTR Triumph Factory Racing'               },
  { id: 'roberto_garcia',      voornaam: 'Roberto',    naam: 'GARCIA',         landCode: 'es', nummer: 37, merk: 'Yamaha',   team: 'GMT94 Yamaha'                             },
  { id: 'mattia_casadei',      voornaam: 'Mattia',     naam: 'CASADEI',        landCode: 'it', nummer: 40, merk: 'Ducati',   team: 'D34G WorldSSP Racing Team'                },
  { id: 'simon_jespersen',     voornaam: 'Simon',      naam: 'JESPERSEN',      landCode: 'dk', nummer: 43, merk: 'Ducati',   team: 'EAB Racing Team'                          },
  { id: 'hector_garzo',        voornaam: 'Héctor',     naam: 'GARZO',          landCode: 'es', nummer: 44, merk: 'Ducati',   team: 'Renzi Corse'                              },
  { id: 'ondrej_vostatek',     voornaam: 'Ondrej',     naam: 'VOŠTATEK',       landCode: 'cz', nummer: 50, merk: 'Kawasaki', team: 'Compos Racing Team'                       },
  { id: 'jeremy_alcoba',       voornaam: 'Jeremy',     naam: 'ALCOBA',         landCode: 'es', nummer: 52, merk: 'Kawasaki', team: 'Kawasaki WorldSSP Team'                   },
  { id: 'valentin_debise',     voornaam: 'Valentin',   naam: 'DEBISE',         landCode: 'fr', nummer: 53, merk: 'Kawasaki', team: 'ZXMOTO Factory Evan Bros Racing'          },
  { id: 'petr_svoboda',        voornaam: 'Petr',       naam: 'SVOBODA',        landCode: 'cz', nummer: 55, merk: 'Yamaha',   team: 'WRP Racing'                               },
  { id: 'aldi_mahendra',       voornaam: 'Aldi',       naam: 'MAHENDRA',       landCode: 'id', nummer: 57, merk: 'Yamaha',   team: 'AS bLU cRU Racing Team'                   },
  { id: 'can_oncu',            voornaam: 'Can',        naam: 'ÖNCÜ',           landCode: 'tr', nummer: 61, merk: 'Yamaha',   team: 'Pata Yamaha Ten Kate Racing'              },
  { id: 'federico_caricasulo', voornaam: 'Federico',   naam: 'CARICASULO',     landCode: 'it', nummer: 64, merk: 'Kawasaki', team: 'ZXMOTO Factory Evan Bros Racing'          },
  { id: 'philipp_oettl',       voornaam: 'Philipp',    naam: 'OETTL',          landCode: 'de', nummer: 65, merk: 'Ducati',   team: 'Feel Racing WorldSSP Team'                },
  { id: 'tom_booth_amos',      voornaam: 'Tom',        naam: 'BOOTH-AMOS',     landCode: 'gb', nummer: 69, merk: 'Triumph',  team: 'PTR Triumph Factory Racing'               },
  { id: 'josh_whatley',        voornaam: 'Josh',       naam: 'WHATLEY',        landCode: 'gb', nummer: 70, merk: 'Ducati',   team: 'Orelac Racing Verdnatura'                 },
  { id: 'jacopo_cretaro',      voornaam: 'Jacopo',     naam: 'CRETARO',        landCode: 'it', nummer: 73, merk: 'MV',       team: 'Flembbo by Racing Development'            },
  { id: 'albert_arenas',       voornaam: 'Albert',     naam: 'ARENAS',         landCode: 'es', nummer: 75, merk: 'Yamaha',   team: 'AS bLU cRU Racing Team'                   },
  { id: 'dominique_aegerter',  voornaam: 'Dominique',  naam: 'AEGERTER',       landCode: 'ch', nummer: 77, merk: 'Kawasaki', team: 'Kawasaki WorldSSP Team'                   },
  { id: 'andrea_giombini',     voornaam: 'Andrea',     naam: 'GIOMBINI',       landCode: 'it', nummer: 88, merk: 'MV',       team: 'Motozoo by Madforce Dubai'                },
