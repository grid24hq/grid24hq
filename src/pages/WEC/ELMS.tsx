// ─── European Le Mans Series 2026 — IMSA-stijl TeamRij ────────────────────────
...
const MERK_KLEUR: Record<string, string> = {
  ...
  Porsche: '#c0a060', Mercedes: '#00d2be', Aston: '#006b5b', 'Aston Martin': '#006b5b',
...
const TEAMS: Team[] = [
  // ── LMP2 ──
  { id:'elms-10', nr:10, naam:'Nielsen Racing',            fabrikant:'Oreca',  carModel:'oreca-07', klasse:'LMP2', kleur:'#ff0000', info:'Oreca 07 Gibson — Nielsen Racing.',
  ...
  { id:'elms-34', nr:34, naam:'Inter Europol Competition', fabrikant:'Oreca',  carModel:'oreca-07', klasse:'LMP2', kleur:'#0057a8', info:'Oreca 07 Gibson — Inter Europol #34.',
  ...
  { id:'elms-43', nr:43, naam:'Inter Europol Competition', fabrikant:'Oreca',  carModel:'oreca-07', klasse:'LMP2', kleur:'#0057a8', info:'Oreca 07 Gibson — Inter Europol #43.',
  ...
  { id:'elms-33', nr:33, naam:'Corvette Racing',           fabrikant:'Corvette', carModel:'corvette-z06-lmgt3', klasse:'LMGT3', kleur:'#ffcc00', info:'Corvette Z06 LMGT3.R — Corvette Racing.',
  ...
  { id:'elms-13', nr:13, naam:'Inter Europol Competition', fabrikant:'Ligier',   carModel:'ligier-js-p325', klasse:'LMP3', kleur:'#0057a8', info:'Ligier JS P325 — Inter Europol #13.',
    ...
    <div className="relative flex items-center group cursor-pointer overflow-hidden transition-all duration-300"
      ...
      <div className="flex-1 flex flex-col justify-center px-5 min-w-0">
        <div className="flex items-baseline gap-3">
          <span className="font-head font-black text-2xl leading-none" style={{ color: klasseKleur }}>#{team.nr}</span>
            ...
            <div className="flex gap-1">
              {tabs.map(t => (
                <button key={t.id} onClick={() => setTab(t.id)}
                  ...
                  style={tab === t.id ? { color: c, borderBottom: `2px solid ${c}` } : { color: 'rgba(255,255,255,0.35)', borderBottom: '2px solid transparent' }}>
                  {t.label}
                </button>
              ))}
            </div>
            <button onClick={onClose}
              className="w-8 h-8 rounded-full flex items-center justify-center text-white/40 hover:text-white hover:bg-white/10 transition-colors text-sm mb-1">✕</button>
          </div>
            ...
            {tab === 'overzicht' && (
              <div className="space-y-5">
                <div className="grid grid-cols-3 gap-3">
                  {[
                    { label: 'Team', val: team.naam }, { label: 'Nummer', val: `#${team.nr}` },
...
export default function ELMS() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-8 py-8 md:py-10">
      <div className="mb-1" style={{ color: '#f97316' }}>
      ...
      <div className="flex flex-col md:flex-row md:items-end gap-3 mb-6">
        <h1 className="font-head font-black text-5xl uppercase tracking-tight leading-none flex items-center gap-3">
          <span style={{ color: '#f97316' }}>ELMS</span>
      ...
      <div className="flex flex-wrap gap-2 mb-4">
        {klassen.map(k => {
          const ac = filter === k
          const kl = KLASSE_KLEUR[k] ?? '#f97316'
          return (
