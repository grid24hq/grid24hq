...
const TEAMS: Team[] = [
  ...
  { id:'e-pa-21', nr:21, naam:'United Autosports',                fabrikant:'Oreca', carModel:'oreca-07', klasse:'LMP2 Pro/Am', kleur:'#cc0000', info:'Oreca 07 Gibson — DragonSpeed Pro/Am.',
  ...
  { id:'e-pa-27', nr:27, naam:'Nielsen Racing',                   fabrikant:'Oreca', carModel:'oreca-07', klasse:'LMP2 Pro/Am', kleur:'#888888', info:'Oreca 07 Gibson — CD Sport Pro/Am.',
  ...
  { id:'e-pa-47', nr:47, naam:'CLX Motorsport',          fabrikant:'Oreca', carModel:'oreca-07', klasse:'LMP2 Pro/Am', kleur:'#003366', info:'Oreca 07 Gibson — Algarve Pro Racing Pro/Am.',
    drivers:[{id:'charles-milesi',naam:'Charles Milesi',nationaliteit:'Frankrijk',vlag:'🇫🇷'},{id:'felipe-fraga',naam:'Felipe Fraga',nationaliteit:'Brazilië',vlag:'🇧🇷'},{id:'georgios-kolovos',naam:'Georgios Kolovos',nationaliteit:'Griekenland',vlag:'🇬🇷'}] },
  { id:'e-pa-7',  nr:7,  naam:'Vector Sport',              fabrikant:'Oreca', carModel:'oreca-07', klasse:'LMP2 Pro/Am', kleur:'#ff0000', info:'Oreca 07 Gibson — Nielsen Racing Pro/Am #7.',
  ...
  { id:'e-59', nr:59, naam:'Racing Spirit of Leman', fabrikant:'Aston Martin', carModel:'aston-martin-amr-lmgt3',    klasse:'LMGT3', kleur:'#006b5b', info:'Aston Martin AMR LMGT3 — Racing Spirit of Leman.',
