...
const TEAMS: Team[] = [
  // ── LMP2 ──
  { id:'e-9',   nr:9,   naam:'Proton Competition',        fabrikant:'Oreca', carModel:'oreca-07', klasse:'LMP2', kleur:'#003e99', info:'Oreca 07 Gibson — Proton Competition.',
  ...
  { id:'e-10',  nr:10,  naam:'Vector Sport',              fabrikant:'Oreca', carModel:'oreca-07', klasse:'LMP2', kleur:'#ff6600', info:'Oreca 07 Gibson — Vector Sport.',
  ...
  { id:'e-24',  nr:24,  naam:'Nielsen Racing',            fabrikant:'Oreca', carModel:'oreca-07', klasse:'LMP2', kleur:'#ff0000', info:'Oreca 07 Gibson — Nielsen Racing.',
  ...
  { id:'e-25',  nr:25,  naam:'Algarve Pro Racing',        fabrikant:'Oreca', carModel:'oreca-07', klasse:'LMP2', kleur:'#003366', info:'Oreca 07 Gibson — Algarve Pro Racing.',
  ...
  { id:'e-28',  nr:28,  naam:'IDEC Sport',                fabrikant:'Oreca', carModel:'oreca-07', klasse:'LMP2', kleur:'#004080', info:'Oreca 07 Gibson — IDEC Sport.',
    drivers:[{id:'paul-lafargue',naam:'Paul Lafargue',nationaliteit:'Frankrijk',vlag:'🇫🇷'},{id:'paul-loup-chatin',naam:'Paul-Loup Chatin',nationaliteit:'Frankrijk',vlag:'🇫🇷'},{id:'job-van-uitert',naam:'Job van Uitert',nationaliteit:'Nederland',vlag:'🇳🇱'}] },
  { id:'e-29',  nr:29,  naam:'Forestier Racing By Panis', fabrikant:'Oreca', carModel:'oreca-07', klasse:'LMP2', kleur:'#006b00', info:'Oreca 07 Gibson — Forestier Racing By Panis.',
  ...
  { id:'e-34',  nr:34,  naam:'Inter Europol Competition', fabrikant:'Oreca', carModel:'oreca-07', klasse:'LMP2', kleur:'#0057a8', info:'Oreca 07 Gibson — Inter Europol Competition.',
  ...
  { id:'e-37',  nr:37,  naam:'CLX Motorsport',            fabrikant:'Oreca', carModel:'oreca-07', klasse:'LMP2', kleur:'#00aaff', info:'Oreca 07 Gibson — CLX Motorsport.',
  ...
  { id:'e-43',  nr:43,  naam:'Inter Europol Competition', fabrikant:'Oreca', carModel:'oreca-07', klasse:'LMP2', kleur:'#0057a8', info:'Oreca 07 Gibson — Inter Europol Competition.',
  ...
  { id:'e-pa-3',  nr:3,  naam:'DKR Engineering',          fabrikant:'Oreca', carModel:'oreca-07', klasse:'LMP2 Pro/Am', kleur:'#666666', info:'Oreca 07 Gibson — DKR Engineering.',
  ...
  { id:'e-pa-7',  nr:7,  naam:'Vector Sport',             fabrikant:'Oreca', carModel:'oreca-07', klasse:'LMP2 Pro/Am', kleur:'#ff6600', info:'Oreca 07 Gibson — Vector Sport.',
  ...
  { id:'e-pa-14', nr:14, naam:'TDS Racing',               fabrikant:'Oreca', carModel:'oreca-07', klasse:'LMP2 Pro/Am', kleur:'#cc0000', info:'Oreca 07 Gibson — TDS Racing.',
    drivers:[{id:'francois-heriau',naam:'François Heriau',nationaliteit:'Frankrijk',vlag:'🇫🇷'},{id:'mathieu-jaminet',naam:'Mathieu Jaminet',nationaliteit:'Frankrijk',vlag:'🇫🇷'}] },
  { id:'e-pa-19', nr:19, naam:'Rossa Racing By Virage',   fabrikant:'Oreca', carModel:'oreca-07', klasse:'LMP2 Pro/Am', kleur:'#cc0000', info:'Oreca 07 Gibson — Rossa Racing By Virage.',
    drivers:[{id:'manuel-espirito-santo',naam:'Manuel Espírito Santo',nationaliteit:'Portugal',vlag:'🇵🇹'},{id:'rik-koen',naam:'Rik Koen',nationaliteit:'Nederland',vlag:'🇳🇱'}] },
  { id:'e-pa-20', nr:20, naam:'Algarve Pro Racing',       fabrikant:'Oreca', carModel:'oreca-07', klasse:'LMP2 Pro/Am', kleur:'#003366', info:'Oreca 07 Gibson — Algarve Pro Racing.',
    drivers:[{id:'malthe-jakobsen',naam:'Malthe Jakobsen',nationaliteit:'Denemarken',vlag:'🇩🇰'},{id:'michael-jensen',naam:'Michael Jensen',nationaliteit:'Denemarken',vlag:'🇩🇰'}] },
  { id:'e-pa-21', nr:21, naam:'United Autosports',        fabrikant:'Oreca', carModel:'oreca-07', klasse:'LMP2 Pro/Am', kleur:'#ff6600', info:'Oreca 07 Gibson — United Autosports.',
    drivers:[{id:'oliver-jarvis',naam:'Oliver Jarvis',nationaliteit:'Engeland',vlag:'🇬🇧'},{id:'marino-sato',naam:'Marino Sato',nationaliteit:'Japan',vlag:'🇯🇵'}] },
  { id:'e-pa-27', nr:27, naam:'Nielsen Racing',           fabrikant:'Oreca', carModel:'oreca-07', klasse:'LMP2 Pro/Am', kleur:'#ff0000', info:'Oreca 07 Gibson — Nielsen Racing.',
    drivers:[{id:'alex-quinn',naam:'Alex Quinn',nationaliteit:'Engeland',vlag:'🇬🇧'},{id:'james-allen',naam:'James Allen',nationaliteit:'Australië',vlag:'🇦🇺'}] },
  { id:'e-pa-30', nr:30, naam:'Duqueine Team',            fabrikant:'Oreca', carModel:'oreca-07', klasse:'LMP2 Pro/Am', kleur:'#cc0000', info:'Oreca 07 Gibson — Duqueine Team.',
  ...
  { id:'e-pa-47', nr:47, naam:'CLX Motorsport',           fabrikant:'Oreca', carModel:'oreca-07', klasse:'LMP2 Pro/Am', kleur:'#00aaff', info:'Oreca 07 Gibson — CLX Motorsport.',
    drivers:[{id:'john-falb',naam:'John Falb',nationaliteit:'VS',vlag:'🇺🇸'},{id:'manuel-espirito-santo-2',naam:'Manuel Espírito Santo',nationaliteit:'Portugal',vlag:'🇵🇹'}] },
  { id:'e-pa-83', nr:83, naam:'AF Corse',                 fabrikant:'Oreca', carModel:'oreca-07', klasse:'LMP2 Pro/Am', kleur:'#e8002d', info:'Oreca 07 Gibson — AF Corse.',
  ...
  { id:'e-pa-88', nr:88, naam:'Proton Competition',       fabrikant:'Oreca', carModel:'oreca-07', klasse:'LMP2 Pro/Am', kleur:'#003e99', info:'Oreca 07 Gibson — Proton Competition.',
    drivers:[{id:'horst-felbermayr',naam:'Horst Felbermayr',nationaliteit:'Oostenrijk',vlag:'🇦🇹'},{id:'rene-binder',naam:'René Binder',nationaliteit:'Oostenrijk',vlag:'🇦🇹'}] },
  { id:'e-pa-99', nr:99, naam:'AO By TF',                 fabrikant:'Oreca', carModel:'oreca-07', klasse:'LMP2 Pro/Am', kleur:'#ff6600', info:'Oreca 07 Gibson — AO By TF.',
  ...
  // ── LMGT3 ──
  { id:'e-23', nr:23, naam:'United Autosports',           fabrikant:'McLaren',      carModel:'mclaren-720s-lmgt3-evo', klasse:'LMGT3', kleur:'#ff8000', info:'McLaren 720S LMGT3 Evo — United Autosports.',
  ...
  { id:'e-33', nr:33, naam:'TF Sport',                    fabrikant:'Corvette',     carModel:'corvette-z06-lmgt3',     klasse:'LMGT3', kleur:'#ffcc00', info:'Corvette Z06 LMGT3.R — TF Sport.',
  ...
  { id:'e-50', nr:50, naam:'Richard Mille AF Corse',      fabrikant:'Ferrari',      carModel:'ferrari-296-lmgt3',      klasse:'LMGT3', kleur:'#e8002d', info:'Ferrari 296 LMGT3 Evo — Richard Mille AF Corse.',
  ...
  { id:'e-51', nr:51, naam:'AF Corse',                    fabrikant:'Ferrari',      carModel:'ferrari-296-lmgt3',      klasse:'LMGT3', kleur:'#e8002d', info:'Ferrari 296 LMGT3 Evo — AF Corse.',
  ...
  { id:'e-54', nr:54, naam:'High Class Racing',           fabrikant:'Porsche',      carModel:'porsche-911-gt3-r-lmgt3',klasse:'LMGT3', kleur:'#c0a060', info:'Porsche 911 GT3 R LMGT3 — High Class Racing.',
  ...
  { id:'e-55', nr:55, naam:'Spirit Of Race',              fabrikant:'Ferrari',      carModel:'ferrari-296-lmgt3',      klasse:'LMGT3', kleur:'#e8002d', info:'Ferrari 296 LMGT3 Evo — Spirit Of Race.',
  ...
  { id:'e-57', nr:57, naam:'Kessel Racing',               fabrikant:'Ferrari',      carModel:'ferrari-296-lmgt3',      klasse:'LMGT3', kleur:'#e8002d', info:'Ferrari 296 LMGT3 Evo — Kessel Racing.',
  ...
  { id:'e-59', nr:59, naam:'Racing Spirit Of Leman',      fabrikant:'Aston Martin', carModel:'aston-martin-amr-lmgt3', klasse:'LMGT3', kleur:'#006b5b', info:'Aston Martin Vantage AMR LMGT3 — Racing Spirit Of Leman.',
  ...
  { id:'e-62', nr:62, naam:'Team Qatar By Iron Lynx',     fabrikant:'Mercedes',     carModel:'mercedes-amg-lmgt3',     klasse:'LMGT3', kleur:'#00d2be', info:'Mercedes AMG LMGT3 — Team Qatar By Iron Lynx.',
  ...
  { id:'e-63', nr:63, naam:'Iron Lynx',                   fabrikant:'Mercedes',     carModel:'mercedes-amg-lmgt3',     klasse:'LMGT3', kleur:'#00d2be', info:'Mercedes AMG LMGT3 — Iron Lynx.',
  ...
  { id:'e-74', nr:74, naam:'Kessel Racing',               fabrikant:'Ferrari',      carModel:'ferrari-296-lmgt3',      klasse:'LMGT3', kleur:'#e8002d', info:'Ferrari 296 LMGT3 — Kessel Racing.',
  ...
  { id:'e-75', nr:75, naam:'Proton Competition',          fabrikant:'Porsche',      carModel:'porsche-911-gt3-r-lmgt3',klasse:'LMGT3', kleur:'#c0a060', info:'Porsche 911 GT3 R LMGT3 — Proton Competition.',
  ...
  { id:'e-77', nr:77, naam:'Proton Competition',          fabrikant:'Porsche',      carModel:'porsche-911-gt3-r-lmgt3',klasse:'LMGT3', kleur:'#c0a060', info:'Porsche 911 GT3 R LMGT3 — Proton Competition.',
  ...
  { id:'e-86', nr:86, naam:'GR Racing',                   fabrikant:'Ferrari',      carModel:'ferrari-296-lmgt3',      klasse:'LMGT3', kleur:'#e8002d', info:'Ferrari 296 LMGT3 Evo — GR Racing.',
  ...
  // ── LMP3 ──
  { id:'e-4',  nr:4,  naam:'DKR Engineering',             fabrikant:'Ligier', carModel:'ligier-js-p325', klasse:'LMP3', kleur:'#666666', info:'Ligier JS P325 — DKR Engineering.',
  ...
  { id:'e-5',  nr:5,  naam:'Rinaldi Racing',              fabrikant:'Ligier', carModel:'ligier-js-p325', klasse:'LMP3', kleur:'#cc0000', info:'Ligier JS P325 — Rinaldi Racing.',
    drivers:[{id:'alvise-rodella',naam:'Alvise Rodella',nationaliteit:'Italië',vlag:'🇮🇹'},{id:'jose-fernandes-cautela',naam:'José Fernandes Cautela',nationaliteit:'Portugal',vlag:'🇵🇹'}] },
  { id:'e-8',  nr:8,  naam:'Team Virage',                 fabrikant:'Ligier', carModel:'ligier-js-p325', klasse:'LMP3', kleur:'#a855f7', info:'Ligier JS P325 — Team Virage.',
  ...
  { id:'e-11', nr:11, naam:'Eurointernational',           fabrikant:'Ligier', carModel:'ligier-js-p325', klasse:'LMP3', kleur:'#003366', info:'Ligier JS P325 — Eurointernational.',
    drivers:[{id:'douwe-dedecker',naam:'Douwe Dedecker',nationaliteit:'België',vlag:'🇧🇪'},{id:'matthew-bell',naam:'Matthew Bell',nationaliteit:'Engeland',vlag:'🇬🇧'},{id:'max-van-der-snel',naam:'Max van der Snel',nationaliteit:'Nederland',vlag:'🇳🇱'}] },
  { id:'e-13', nr:13, naam:'Inter Europol Competition',   fabrikant:'Ligier', carModel:'ligier-js-p325', klasse:'LMP3', kleur:'#0057a8', info:'Ligier JS P325 — Inter Europol Competition.',
  ...
  { id:'e-17', nr:17, naam:'CLX Motorsport',              fabrikant:'Ligier', carModel:'ligier-js-p325', klasse:'LMP3', kleur:'#00aaff', info:'Ligier JS P325 — CLX Motorsport.',
  ...
  { id:'e-31', nr:31, naam:'Racing Spirit Of Leman',      fabrikant:'Ligier', carModel:'ligier-js-p325', klasse:'LMP3', kleur:'#c0a060', info:'Ligier JS P325 — Racing Spirit Of Leman.',
  ...
  { id:'e-35', nr:35, naam:'Ultimate',                    fabrikant:'Ligier', carModel:'ligier-js-p325', klasse:'LMP3', kleur:'#888888', info:'Ligier JS P325 — Ultimate.',
    drivers:[{id:'lucas-fecury',naam:'Lucas Fecury',nationaliteit:'Brazilië',vlag:'🇧🇷'},{id:'sebastian-gravlund',naam:'Sebastian Gravlund',nationaliteit:'Denemarken',vlag:'🇩🇰'}] },
  { id:'e-68', nr:68, naam:'M Racing',                    fabrikant:'Ligier', carModel:'ligier-js-p325', klasse:'LMP3', kleur:'#003366', info:'Ligier JS P325 — M Racing.',
  ...
  { id:'e-85', nr:85, naam:'R-ace GP',                    fabrikant:'Ligier', carModel:'ligier-js-p325', klasse:'LMP3', kleur:'#cc0000', info:'Ligier JS P325 — R-ace GP.',
