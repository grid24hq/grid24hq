...
const TEAMS: Team[] = [
  // ── LMP2 ──
  { id:'e-10', nr:10, naam:'Vector Sport',            fabrikant:'Oreca', carModel:'Oreca-07-Gibson', klasse:'LMP2', kleur:'#ff0000', info:'Oreca 07 Gibson — Nielsen Racing.',
  ...
  { id:'e-18', nr:18, naam:'IDEC Sport',                fabrikant:'Oreca', carModel:'Oreca-07-Gibson', klasse:'LMP2', kleur:'#004080', info:'Oreca 07 Gibson — IDEC Sport.',
  ...
  { id:'e-22', nr:22, naam:'United Autosports',         fabrikant:'Oreca', carModel:'Oreca-07-Gibson', klasse:'LMP2', kleur:'#ff6600', info:'Oreca 07 Gibson — United Autosports.',
  ...
  { id:'e-24', nr:24, naam:'Nielsen Racing',            fabrikant:'Oreca', carModel:'Oreca-07-Gibson', klasse:'LMP2', kleur:'#ff0000', info:'Oreca 07 Gibson — Nielsen Racing #24.',
  ...
  { id:'e-25', nr:25, naam:'Algarve Pro Racing',               fabrikant:'Oreca', carModel:'Oreca-07-Gibson', klasse:'LMP2', kleur:'#00aaff', info:'Oreca 07 Gibson — Cool Racing #25.',
  ...
  { id:'e-28', nr:28, naam:'IDEC Sport',                fabrikant:'Oreca', carModel:'Oreca-07-Gibson', klasse:'LMP2', kleur:'#003087', info:'Oreca 07 Gibson — JOTA Sport.',
  ...
  { id:'e-29', nr:29, naam:'Forestier Racing By Panis',         fabrikant:'Oreca', carModel:'Oreca-07-Gibson', klasse:'LMP2', kleur:'#ff9933', info:'Oreca 07 Gibson — Racing Team India.',
  ...
  { id:'e-34', nr:34, naam:'Inter Europol Competition', fabrikant:'Oreca', carModel:'Oreca-07-Gibson', klasse:'LMP2', kleur:'#0057a8', info:'Oreca 07 Gibson — Inter Europol #34.',
  ...
  { id:'e-37', nr:37, naam:'CLX Motorsport',            fabrikant:'Oreca', carModel:'Oreca-07-Gibson', klasse:'LMP2', kleur:'#005bbb', info:'Oreca 07 Gibson — ARC Bratislava.',
  ...
  { id:'e-43', nr:43, naam:'Inter Europol Competition', fabrikant:'Oreca', carModel:'Oreca-07-Gibson', klasse:'LMP2', kleur:'#0057a8', info:'Oreca 07 Gibson — Inter Europol #43.',
  ...
  { id:'e-47', nr:47, naam:'Algarve Pro Racing',        fabrikant:'Oreca', carModel:'Oreca-07-Gibson', klasse:'LMP2', kleur:'#003366', info:'Oreca 07 Gibson — Algarve Pro Racing.',
  ...
  { id:'e-pa-14', nr:14, naam:'TDS Racing', fabrikant:'Oreca', carModel:'Oreca-07-Gibson', klasse:'LMP2 Pro/Am', kleur:'#0057a8', info:'Oreca 07 Gibson — Inter Europol Pro/Am #14.',
  ...
  { id:'e-pa-19', nr:19, naam:'Rossa Racing By Virage',               fabrikant:'Oreca', carModel:'Oreca-07-Gibson', klasse:'LMP2 Pro/Am', kleur:'#00aaff', info:'Oreca 07 Gibson — Cool Racing Pro/Am.',
  ...
  { id:'e-pa-20', nr:20, naam:'Algarve Pro Racing',         fabrikant:'Oreca', carModel:'Oreca-07-Gibson', klasse:'LMP2 Pro/Am', kleur:'#e30a17', info:'Oreca 07 Gibson — Racing Team Turkey Pro/Am.',
  ...
  { id:'e-pa-21', nr:21, naam:'United Autosports',                fabrikant:'Oreca', carModel:'Oreca-07-Gibson', klasse:'LMP2 Pro/Am', kleur:'#cc0000', info:'Oreca 07 Gibson — DragonSpeed Pro/Am.',
  ...
  { id:'e-pa-27', nr:27, naam:'Nielsen Racing',                   fabrikant:'Oreca', carModel:'Oreca-07-Gibson', klasse:'LMP2 Pro/Am', kleur:'#888888', info:'Oreca 07 Gibson — CD Sport Pro/Am.',
  ...
  { id:'e-pa-3',  nr:3,  naam:'DKR Engineering',            fabrikant:'Oreca', carModel:'Oreca-07-Gibson', klasse:'LMP2 Pro/Am', kleur:'#666666', info:'Oreca 07 Gibson — DKR Engineering Pro/Am.',
  ...
  { id:'e-pa-30', nr:30, naam:'Duqueine Team',               fabrikant:'Oreca', carModel:'Oreca-07-Gibson', klasse:'LMP2 Pro/Am', kleur:'#cc0000', info:'Oreca 07 Gibson — Duqueine Team Pro/Am.',
  ...
  { id:'e-pa-47', nr:47, naam:'CLX Motorsport',          fabrikant:'Oreca', carModel:'Oreca-07-Gibson', klasse:'LMP2 Pro/Am', kleur:'#003366', info:'Oreca 07 Gibson — Algarve Pro Racing Pro/Am.',
    drivers:[{id:'charles-milesi',naam:'Charles Milesi',nationaliteit:'Frankrijk',vlag:'🇫🇷'},{id:'felipe-fraga',naam:'Felipe Fraga',nationaliteit:'Brazilië',vlag:'🇧🇷'},{id:'georgios-kolovos',naam:'Georgios Kolovos',nationaliteit:'Griekenland',vlag:'🇬🇷'}] },
  { id:'e-pa-7',  nr:7,  naam:'Vector Sport',              fabrikant:'Oreca', carModel:'Oreca-07-Gibson', klasse:'LMP2 Pro/Am', kleur:'#ff0000', info:'Oreca 07 Gibson — Nielsen Racing Pro/Am #7.',
  ...
  { id:'e-pa-83', nr:83, naam:'AF Corse',                    fabrikant:'Oreca', carModel:'Oreca-07-Gibson', klasse:'LMP2 Pro/Am', kleur:'#e8002d', info:'Oreca 07 Gibson — AF Corse Pro/Am.',
  ...
  { id:'e-pa-88', nr:88, naam:'Proton Competition',    fabrikant:'Oreca', carModel:'Oreca-07-Gibson', klasse:'LMP2 Pro/Am', kleur:'#c0a060', info:'Oreca 07 Gibson — Felbermayr Proton Pro/Am.',
  ...
  { id:'e-pa-99', nr:99, naam:'Ao By TfS',                fabrikant:'Oreca', carModel:'Oreca-07-Gibson', klasse:'LMP2 Pro/Am', kleur:'#ff0000', info:'Oreca 07 Gibson — Prema Racing Pro/Am.',
  ...
  { id:'e-33', nr:33, naam:'Corvette Racing',     fabrikant:'Corvette',     carModel:'Corvette-Z06-LMGT3.R',        klasse:'LMGT3', kleur:'#ffcc00', info:'Corvette Z06 LMGT3.R.',
  ...
  { id:'e-50', nr:50, naam:'Iron Lynx',           fabrikant:'Ferrari',      carModel:'Ferrari-296-LMGT3-Evo',         klasse:'LMGT3', kleur:'#e8002d', info:'Ferrari 296 LMGT3 — Iron Lynx #50.',
  ...
  { id:'e-51', nr:51, naam:'AF Corse',            fabrikant:'Ferrari',      carModel:'Ferrari-296-LMGT3-Evo',         klasse:'LMGT3', kleur:'#e8002d', info:'Ferrari 296 LMGT3 — AF Corse.',
  ...
  { id:'e-55', nr:55, naam:'Spirit of Race',      fabrikant:'Ferrari',      carModel:'Ferrari-296-LMGT3-Evo',         klasse:'LMGT3', kleur:'#e8002d', info:'Ferrari 296 LMGT3 — Spirit of Race.',
  ...
  { id:'e-57', nr:57, naam:'Kessel Racing',       fabrikant:'Ferrari',      carModel:'Ferrari-296-LMGT3-Evo',         klasse:'LMGT3', kleur:'#e8002d', info:'Ferrari 296 LMGT3 — Kessel Racing.',
  ...
  { id:'e-59', nr:59, naam:'Racing Spirit of Leman', fabrikant:'Aston Martin', carModel:'Aston-Martin-Vantage-AMR-LMGT3',    klasse:'LMGT3', kleur:'#006b5b', info:'Aston Martin AMR LMGT3 — Racing Spirit of Leman.',
  ...
  { id:'e-74', nr:74, naam:'GR Racing',           fabrikant:'Ferrari',      carModel:'Ferrari-296-LMGT3-Evo',         klasse:'LMGT3', kleur:'#e8002d', info:'Ferrari 296 LMGT3 — GR Racing.',
  ...
  { id:'e-86', nr:86, naam:'GR Racing',           fabrikant:'Ferrari',      carModel:'Ferrari-296-LMGT3-Evo',         klasse:'LMGT3', kleur:'#e8002d', info:'Ferrari 296 LMGT3 — GR Racing #86.',
  ...
  // ── LMP3 ──
  { id:'e-11', nr:11, naam:'V de V Motorsports',        fabrikant:'Ligier',   carModel:'Ligier-JS-P325-Toyota', klasse:'LMP3', kleur:'#a855f7', info:'Ligier JS P325 — V de V Motorsports.',
  ...
  { id:'e-13', nr:13, naam:'Inter Europol Competition', fabrikant:'Ligier',   carModel:'Ligier-JS-P325-Toyota', klasse:'LMP3', kleur:'#0057a8', info:'Ligier JS P325 — Inter Europol #13.',
  ...
  { id:'e-17', nr:17, naam:'CD Sport',                  fabrikant:'Ligier',   carModel:'Ligier-JS-P325-Toyota', klasse:'LMP3', kleur:'#888888', info:'Ligier JS P325 — CD Sport #17.',
  ...
  { id:'e-31', nr:31, naam:'TF Sport',                  fabrikant:'Ligier',   carModel:'Ligier-JS-P325-Toyota', klasse:'LMP3', kleur:'#004080', info:'Ligier JS P325 — TF Sport.',
  ...
  { id:'e-35', nr:35, naam:'RLR MSport',                fabrikant:'Ligier',   carModel:'Ligier-JS-P325-Toyota', klasse:'LMP3', kleur:'#c0a060', info:'Ligier JS P325 — RLR MSport.',
  ...
  { id:'e-4',  nr:4,  naam:'DKR Engineering',           fabrikant:'Ligier',   carModel:'Ligier-JS-P325-Toyota', klasse:'LMP3', kleur:'#666666', info:'Ligier JS P325 — DKR Engineering #4.',
  ...
  { id:'e-5',  nr:5,  naam:'MV2S Racing',               fabrikant:'Ligier',   carModel:'Ligier-JS-P325-Toyota', klasse:'LMP3', kleur:'#003366', info:'Ligier JS P325 — MV2S Racing.',
  ...
  { id:'e-68', nr:68, naam:'Graff Racing',              fabrikant:'Ligier',   carModel:'Ligier-JS-P325-Toyota', klasse:'LMP3', kleur:'#cc0000', info:'Ligier JS P325 — Graff Racing.',
  ...
  { id:'e-8',  nr:8,  naam:'Nielsen Racing',            fabrikant:'Ligier',   carModel:'Ligier-JS-P325-Toyota', klasse:'LMP3', kleur:'#ff0000', info:'Ligier JS P325 — Nielsen Racing #8.',
  ...
  { id:'e-85', nr:85, naam:'RLR MSport',                fabrikant:'Duqueine', carModel:'Duqueine-D09-Toyota',   klasse:'LMP3', kleur:'#c0a060', info:'Duqueine D09 — RLR MSport #85.',
...
const TEAM_LOGO: Record<string, string> = {
  ...
  'e-34':     'inter-europol-competition-no34.webp',
  'e-37':     'clx-motorsport-no37.webp',
  'e-43':     'inter-europol-competition-no43.webp',
  // LMP2 Pro/Am
  'e-pa-3':   'dkr-engineering-no3.webp',
  'e-pa-7':   'vector-sport-no7.webp',
  'e-pa-14':  'tds-racing-no14.webp',
  'e-pa-19':  'rossa-racing-by-virage-no19.webp',
  'e-pa-20':  'algarve-pr-racing-no20.webp',
  'e-pa-21':  'united-autosports-no21.webp',
  'e-pa-27':  'nielsen-racing-no27.webp',
  'e-pa-30':  'duqueine-team-no30.webp',
  'e-pa-47':  'clx-motorsport-no47.webp',
  'e-pa-83':  'af-corse-no83.webp',
  ...
  'e-13':     'inter-europol-competition-no13.webp',
  'e-17':     'clx-motorsport-no17.webp',
  'e-31':     'racing-sprint-of-leman-no31.webp',
  'e-35':     'ultimate-no35.webp',
  'e-68':     'm-racing-no68.webp',
  'e-85':     'r-ace-gp-no85.webp',
  // LMGT3
  ...
  'e-62':     'team-qatar-by-iron-lynx-no62.webp',
  'e-63':     'iron-lynx-no63.webp',
  'e-74':     'kessel-racing-no74.webp',
  'e-75':     'proton-competition-no75.webp',
  'e-77':     'proton-competition-no77.webp',
  'e-86':     'gr-racing-no-86.webp',
}
...
function TeamLogo({ id, naam }: { id: string; naam: string }) {
  ...
  if (!file) return null
  return <img src={`/wec/europeanlemansseries/all_team_logos/${file}`} alt={naam} onError={()=>setErr(true)}
