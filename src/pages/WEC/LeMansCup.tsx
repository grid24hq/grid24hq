...
const TEAMS: Team[] = [
  ...
  { id:'m-gt3-10', nr:10, naam:'Racing Spirit Of Leman', fabrikant:'Aston Martin', carModel:'aston-martin-gt3', klasse:'GT3', kleur:'#006b5b', info:'Aston Martin Vantage AMR GT3 Evo — Racing Spirit Of Leman.',
    drivers:[{id:'clement-mateu-2',naam:'Clement Mateu',nationaliteit:'Frankrijk',vlag:'🇫🇷'},{id:'valentin-hasse-2',naam:'Valentin Hasse',nationaliteit:'Frankrijk',vlag:'🇫🇷'}] },
  { id:'m-gt3-11', nr:11, naam:'Code Racing Development', fabrikant:'Aston Martin', carModel:'aston-martin-gt3', klasse:'GT3', kleur:'#006b5b', info:'Aston Martin Vantage AMR GT3 Evo — Code Racing Development.',
  ...
  { id:'m-gt3-17', nr:17, naam:'Kessel Racing',           fabrikant:'Ferrari',      carModel:'ferrari-296',      klasse:'GT3', kleur:'#e8002d', info:'Ferrari 296 GT3 Evo — Kessel Racing.',
  ...
  { id:'m-gt3-21', nr:21, naam:'Kessel Racing',           fabrikant:'Ferrari',      carModel:'ferrari-296',      klasse:'GT3', kleur:'#e8002d', info:'Ferrari 296 GT3 Evo — Kessel Racing.',
  ...
  { id:'m-gt3-23', nr:23, naam:'Biogas Motorsport',       fabrikant:'Ferrari',      carModel:'ferrari-296',      klasse:'GT3', kleur:'#22c55e', info:'Ferrari 296 GT3 — Biogas Motorsport.',
    drivers:[{id:'marc-carol-ybarra',naam:'Marc Carol Ybarra',nationaliteit:'Spanje',vlag:'🇪🇸'},{id:'josep-mayola',naam:'Josep Mayola',nationaliteit:'Spanje',vlag:'🇪🇸'}] },
  { id:'m-gt3-51', nr:51, naam:'AF Corse',                fabrikant:'Ferrari',      carModel:'ferrari-296',      klasse:'GT3', kleur:'#e8002d', info:'Ferrari 296 GT3 Evo — AF Corse.',
  ...
  { id:'m-gt3-54', nr:54, naam:'Dinamic GT',              fabrikant:'Porsche',      carModel:'porsche-911-gt3',  klasse:'GT3', kleur:'#c0a060', info:'Porsche 911 GT3 (992) EVO — Dinamic GT.',
    drivers:[{id:'matteo-cressoni',naam:'Matteo Cressoni',nationaliteit:'Italië',vlag:'🇮🇹'},{id:'laurin-heinrich-2',naam:'Laurin Heinrich',nationaliteit:'Duitsland',vlag:'🇩🇪'}] },
  { id:'m-gt3-77', nr:77, naam:'SMC Motorsport',          fabrikant:'McLaren',      carModel:'mclaren-720s',     klasse:'GT3', kleur:'#ff8000', info:'McLaren 720S GT3 Evo — SMC Motorsport.',
  ...
  { id:'m-gt3-88', nr:88, naam:'AF Corse',                fabrikant:'Ferrari',      carModel:'ferrari-296',      klasse:'GT3', kleur:'#e8002d', info:'Ferrari 296 GT3 Evo — AF Corse.',
  ...
  { id:'m-gt3-91', nr:91, naam:'Blackthorn',              fabrikant:'Aston Martin', carModel:'aston-martin-gt3', klasse:'GT3', kleur:'#006b5b', info:'Aston Martin Vantage AMR GT3 Evo — Blackthorn.',
  ...
  { id:'m-4',  nr:4,  naam:'Nielsen Racing',             fabrikant:'Duqueine', carModel:'duqueine-d09', klasse:'LMP3', kleur:'#ff0000', info:'Duqueine D09 — Nielsen Racing.',
  ...
  { id:'m-5',  nr:5,  naam:'23Events Racing',            fabrikant:'Ligier',   carModel:'ligier-js-p325', klasse:'LMP3', kleur:'#ff6600', info:'Ligier JS P325 — 23Events Racing.',
  ...
  { id:'m-6',  nr:6,  naam:'ANS Motorsport',             fabrikant:'Ligier',   carModel:'ligier-js-p325', klasse:'LMP3', kleur:'#003366', info:'Ligier JS P325 — ANS Motorsport.',
    drivers:[{id:'arthur-pavie',naam:'Arthur Pavie',nationaliteit:'Frankrijk',vlag:'🇫🇷'},{id:'mikkel-kristensen',naam:'Mikkel Kristensen',nationaliteit:'Denemarken',vlag:'🇩🇰'}] },
  { id:'m-7',  nr:7,  naam:'Nielsen Racing',             fabrikant:'Duqueine', carModel:'duqueine-d09', klasse:'LMP3', kleur:'#ff0000', info:'Duqueine D09 — Nielsen Racing.',
    drivers:[{id:'daniel-nogales',naam:'Daniel Nogales',nationaliteit:'Spanje',vlag:'🇪🇸'},{id:'louis-stern',naam:'Louis Stern',nationaliteit:'Frankrijk',vlag:'🇫🇷'}] },
  { id:'m-8',  nr:8,  naam:'BWT Muecke Motorsport',      fabrikant:'Duqueine', carModel:'duqueine-d09', klasse:'LMP3', kleur:'#ff69b4', info:'Duqueine D09 — BWT Muecke Motorsport.',
  ...
  { id:'m-9',  nr:9,  naam:'ANS Motorsport',             fabrikant:'Ligier',   carModel:'ligier-js-p325', klasse:'LMP3', kleur:'#003366', info:'Ligier JS P325 — ANS Motorsport.',
  ...
  { id:'m-12', nr:12, naam:'Brutal Fish Campos Racing',  fabrikant:'Ligier',   carModel:'ligier-js-p325', klasse:'LMP3', kleur:'#cc0000', info:'Ligier JS P325 — Brutal Fish Campos Racing.',
  ...
  { id:'m-15', nr:15, naam:'Vector Sport RLR',           fabrikant:'Ligier',   carModel:'ligier-js-p325', klasse:'LMP3', kleur:'#ff6600', info:'Ligier JS P325 — Vector Sport RLR.',
  ...
  { id:'m-19', nr:19, naam:'Brutal Fish Campos Racing',  fabrikant:'Ligier',   carModel:'ligier-js-p325', klasse:'LMP3', kleur:'#cc0000', info:'Ligier JS P325 — Brutal Fish Campos Racing.',
  ...
  { id:'m-20', nr:20, naam:'High Class Racing',          fabrikant:'Ligier',   carModel:'ligier-js-p325', klasse:'LMP3', kleur:'#003366', info:'Ligier JS P325 — High Class Racing.',
  ...
  { id:'m-22', nr:22, naam:'Trajectus Motorsport',       fabrikant:'Ligier',   carModel:'ligier-js-p325', klasse:'LMP3', kleur:'#888888', info:'Ligier JS P325 — Trajectus Motorsport.',
  ...
  { id:'m-26', nr:26, naam:'Bretton Racing',             fabrikant:'Ligier',   carModel:'ligier-js-p325', klasse:'LMP3', kleur:'#003366', info:'Ligier JS P325 — Bretton Racing.',
  ...
  { id:'m-29', nr:29, naam:'Forestier Racing By VPS',    fabrikant:'Ligier',   carModel:'ligier-js-p325', klasse:'LMP3', kleur:'#006b00', info:'Ligier JS P325 — Forestier Racing By VPS.',
  ...
  { id:'m-36', nr:36, naam:'Ajith Redant Racing',        fabrikant:'Ligier',   carModel:'ligier-js-p325', klasse:'LMP3', kleur:'#ff6600', info:'Ligier JS P325 — Ajith Redant Racing.',
  ...
  { id:'m-42', nr:42, naam:'Steller Motorsport',         fabrikant:'Duqueine', carModel:'duqueine-d09', klasse:'LMP3', kleur:'#6366f1', info:'Duqueine D09 — Steller Motorsport.',
  ...
  { id:'m-43', nr:43, naam:'Inter Europol Competition',  fabrikant:'Ligier',   carModel:'ligier-js-p325', klasse:'LMP3', kleur:'#0057a8', info:'Ligier JS P325 — Inter Europol Competition.',
  ...
  { id:'m-50', nr:50, naam:'23Events Racing',            fabrikant:'Ligier',   carModel:'ligier-js-p325', klasse:'LMP3', kleur:'#ff6600', info:'Ligier JS P325 — 23Events Racing.',
  ...
  { id:'m-68', nr:68, naam:'M Racing',                   fabrikant:'Ligier',   carModel:'ligier-js-p325', klasse:'LMP3', kleur:'#003366', info:'Ligier JS P325 — M Racing.',
  ...
  { id:'m-70', nr:70, naam:'Team Virage',                fabrikant:'Ligier',   carModel:'ligier-js-p325', klasse:'LMP3', kleur:'#a855f7', info:'Ligier JS P325 — Team Virage.',
  ...
  { id:'m-85', nr:85, naam:'R-ace GP',                   fabrikant:'Duqueine', carModel:'duqueine-d09', klasse:'LMP3', kleur:'#cc0000', info:'Duqueine D09 — R-ace GP.',
  ...
  { id:'m-86', nr:86, naam:'R-ace GP',                   fabrikant:'Duqueine', carModel:'duqueine-d09', klasse:'LMP3', kleur:'#cc0000', info:'Duqueine D09 — R-ace GP.',
  ...
  { id:'m-87', nr:87, naam:'CLX Motorsport',             fabrikant:'Ligier',   carModel:'ligier-js-p325', klasse:'LMP3', kleur:'#00aaff', info:'Ligier JS P325 — CLX Motorsport.',
    drivers:[{id:'fraser-ross',naam:'Fraser Ross',nationaliteit:'Schotland',vlag:'gb-sct'},{id:'george-nakas',naam:'George Nakas',nationaliteit:'Griekenland',vlag:'🇬🇷'}] },
  { id:'m-92', nr:92, naam:'Forestier Racing By VPS',    fabrikant:'Ligier',   carModel:'ligier-js-p325', klasse:'LMP3', kleur:'#006b00', info:'Ligier JS P325 — Forestier Racing By VPS.',
    drivers:[{id:'lucas-fecury',naam:'Lucas Fecury',nationaliteit:'Brazilië',vlag:'🇧🇷'},{id:'sebastian-kirchbach',naam:'Sebastian Kirchbach',nationaliteit:'Duitsland',vlag:'🇩🇪'}] },
  { id:'m-97', nr:97, naam:'CLX Motorsport',             fabrikant:'Ligier',   carModel:'ligier-js-p325', klasse:'LMP3', kleur:'#00aaff', info:'Ligier JS P325 — CLX Motorsport.',
  ...
  { id:'m-99', nr:99, naam:'More Motorsport',            fabrikant:'Ligier',   carModel:'ligier-js-p325', klasse:'LMP3', kleur:'#888888', info:'Ligier JS P325 — More Motorsport.',
  ...
  { id:'m-pa-16', nr:16, naam:'Ajith Redant By Virage',  fabrikant:'Ligier',   carModel:'ligier-js-p325', klasse:'LMP3 Pro/Am', kleur:'#f59e0b', info:'Ligier JS P325 — Ajith Redant By Virage.',
  ...
  { id:'m-pa-24', nr:24, naam:'Racing Spirit Of Leman',  fabrikant:'Ligier',   carModel:'ligier-js-p325', klasse:'LMP3 Pro/Am', kleur:'#f59e0b', info:'Ligier JS P325 — Racing Spirit Of Leman.',
  ...
  { id:'m-pa-27', nr:27, naam:'P4 Racing',               fabrikant:'Ligier',   carModel:'ligier-js-p325', klasse:'LMP3 Pro/Am', kleur:'#f59e0b', info:'Ligier JS P325 — P4 Racing.',
  ...
  { id:'m-pa-34', nr:34, naam:'Inter Europol Competition',fabrikant:'Ligier',   carModel:'ligier-js-p325', klasse:'LMP3 Pro/Am', kleur:'#f59e0b', info:'Ligier JS P325 — Inter Europol Competition.',
  ...
  { id:'m-pa-49', nr:49, naam:'High Class Racing',        fabrikant:'Ligier',   carModel:'ligier-js-p325', klasse:'LMP3 Pro/Am', kleur:'#f59e0b', info:'Ligier JS P325 — High Class Racing.',
  ...
  { id:'m-pa-58', nr:58, naam:'GG Classics',             fabrikant:'Ligier',   carModel:'ligier-js-p325', klasse:'LMP3 Pro/Am', kleur:'#f59e0b', info:'Ligier JS P325 — GG Classics.',
  ...
  { id:'m-pa-62', nr:62, naam:'Bretton Racing',           fabrikant:'Ligier',   carModel:'ligier-js-p325', klasse:'LMP3 Pro/Am', kleur:'#f59e0b', info:'Ligier JS P325 — Bretton Racing.',
  ...
  { id:'m-pa-66', nr:66, naam:'Rinaldi Racing',           fabrikant:'Ligier',   carModel:'ligier-js-p325', klasse:'LMP3 Pro/Am', kleur:'#f59e0b', info:'Ligier JS P325 — Rinaldi Racing.',
  ...
  { id:'m-pa-71', nr:71, naam:'Rinaldi Racing',           fabrikant:'Ligier',   carModel:'ligier-js-p325', klasse:'LMP3 Pro/Am', kleur:'#f59e0b', info:'Ligier JS P325 — Rinaldi Racing.',
    drivers:[{id:'felipe-fernandez-laser-2',naam:'Felipe Fernandez Laser',nationaliteit:'Duitsland',vlag:'🇩🇪'},{id:'stefan-aust-2',naam:'Stefan Aust',nationaliteit:'Duitsland',vlag:'🇩🇪'}] },
  { id:'m-pa-98', nr:98, naam:'Motorsport98',             fabrikant:'Ligier',   carModel:'ligier-js-p325', klasse:'LMP3 Pro/Am', kleur:'#f59e0b', info:'Ligier JS P325 — Motorsport98.',
