...
const TEAMS: Team[] = [
  ...
  { id:'wec-15',  nr:15,  naam:'BMW M Team WRT',           fabrikant:'BMW',          carModel:'bmwm-hybrid-v8',        klasse:'Hypercar', kleur:'#1c69d4', info:'BMW M Hybrid V8 — BMW M Team WRT.',
  ...
  { id:'wec-20',  nr:20,  naam:'BMW M Team WRT',           fabrikant:'BMW',          carModel:'bmwm-hybrid-v8',        klasse:'Hypercar', kleur:'#1c69d4', info:'BMW M Hybrid V8 — BMW M Team WRT.',
  ...
  { id:'wec-12',  nr:12,  naam:'Cadillac Hertz Team Jota', fabrikant:'Cadillac',     carModel:'cadillac',              klasse:'Hypercar', kleur:'#a0001c', info:'Cadillac V-Series.R — Cadillac Hertz Team Jota.',
  ...
  { id:'wec-38',  nr:38,  naam:'Cadillac Hertz Team Jota', fabrikant:'Cadillac',     carModel:'cadillac',              klasse:'Hypercar', kleur:'#a0001c', info:'Cadillac V-Series.R — Cadillac Hertz Team Jota.',
  ...
  { id:'wec-19',  nr:19,  naam:'Genesis Magma Racing',     fabrikant:'Genesis',      carModel:'genesis',               klasse:'Hypercar', kleur:'#c0a020', info:'Genesis GMR-001 Hypercar — Genesis Magma Racing.',
  ...
  { id:'wec-7',   nr:7,   naam:'Toyota Racing',            fabrikant:'Toyota',       carModel:'toyota-gr010',          klasse:'Hypercar', kleur:'#e8002d', info:'Toyota GR010 Hybrid — Toyota Racing.',
  ...
  { id:'wec-8',   nr:8,   naam:'Toyota Racing',            fabrikant:'Toyota',       carModel:'toyota-gr010',          klasse:'Hypercar', kleur:'#e8002d', info:'Toyota GR010 Hybrid — Toyota Racing.',
  ...
  { id:'wec-gt3-23', nr:23, naam:'Heart of Racing Team',   fabrikant:'Aston Martin', carModel:'aston-martin-gt3',      klasse:'GT3 (LMGT3)', kleur:'#006b5b', info:'Aston Martin Vantage AMR LMGT3 — Heart of Racing Team.',
  ...
  { id:'wec-gt3-27', nr:27, naam:'Heart of Racing Team',   fabrikant:'Aston Martin', carModel:'aston-martin-gt3',      klasse:'GT3 (LMGT3)', kleur:'#006b5b', info:'Aston Martin Vantage AMR LMGT3 — Heart of Racing Team.',
  ...
  { id:'wec-gt3-32', nr:32, naam:'Team WRT',               fabrikant:'BMW',          carModel:'bmw-m4-gt3',            klasse:'GT3 (LMGT3)', kleur:'#1c69d4', info:'BMW M4 LMGT3 Evo — Team WRT.',
  ...
  { id:'wec-gt3-69', nr:69, naam:'Team WRT',               fabrikant:'BMW',          carModel:'bmw-m4-gt3',            klasse:'GT3 (LMGT3)', kleur:'#1c69d4', info:'BMW M4 LMGT3 Evo — Team WRT.',
  ...
  { id:'wec-gt3-33', nr:33, naam:'TF Sport',               fabrikant:'Corvette',     carModel:'corvette-z06-gt3',      klasse:'GT3 (LMGT3)', kleur:'#ffcc00', info:'Corvette Z06 LMGT3.R — TF Sport.',
  ...
  { id:'wec-gt3-34', nr:34, naam:'Racing Team Turkey By TF',fabrikant:'Corvette',    carModel:'corvette-z06-gt3-r',    klasse:'GT3 (LMGT3)', kleur:'#ffcc00', info:'Corvette Z06 LMGT3.R — Racing Team Turkey By TF.',
  ...
  { id:'wec-gt3-21', nr:21, naam:'Vista AF Corse',         fabrikant:'Ferrari',      carModel:'ferrari-296-gt3',       klasse:'GT3 (LMGT3)', kleur:'#e8002d', info:'Ferrari 296 LMGT3 Evo — Vista AF Corse.',
  ...
  { id:'wec-gt3-54', nr:54, naam:'Vista AF Corse',         fabrikant:'Ferrari',      carModel:'ferrari-296-gt3',       klasse:'GT3 (LMGT3)', kleur:'#e8002d', info:'Ferrari 296 LMGT3 Evo — Vista AF Corse.',
  ...
  { id:'wec-gt3-77', nr:77, naam:'Proton Competition',     fabrikant:'Ford',         carModel:'ford-mustang',          klasse:'GT3 (LMGT3)', kleur:'#003e99', info:'Ford Mustang LMGT3 — Proton Competition.',
  ...
  { id:'wec-gt3-88', nr:88, naam:'Proton Competition',     fabrikant:'Ford',         carModel:'ford-mustang',          klasse:'GT3 (LMGT3)', kleur:'#003e99', info:'Ford Mustang LMGT3 — Proton Competition.',
  ...
  { id:'wec-gt3-10', nr:10, naam:'Garage 59',              fabrikant:'McLaren',      carModel:'mclaren-720s',          klasse:'GT3 (LMGT3)', kleur:'#ff8000', info:'McLaren 720S LMGT3 Evo — Garage 59.',
  ...
  { id:'wec-gt3-58', nr:58, naam:'Garage 59',              fabrikant:'McLaren',      carModel:'mclaren-720s',          klasse:'GT3 (LMGT3)', kleur:'#ff8000', info:'McLaren 720S LMGT3 Evo — Garage 59.',
  ...
  { id:'wec-gt3-61', nr:61, naam:'Iron Lynx',              fabrikant:'Mercedes',     carModel:'mercedes-lmgt3',        klasse:'GT3 (LMGT3)', kleur:'#00d2be', info:'Mercedes AMG LMGT3 — Iron Lynx.',
  ...
  { id:'wec-gt3-91', nr:91, naam:'Manthey DK Engineering', fabrikant:'Porsche',      carModel:'porsche-911-gt3',       klasse:'GT3 (LMGT3)', kleur:'#c0a060', info:'Porsche 911 GT3 R LMGT3 — Manthey DK Engineering.',
  ...
  { id:'wec-gt3-92', nr:92, naam:'The Bend Manthey',       fabrikant:'Porsche',      carModel:'porsche-911-gt3',       klasse:'GT3 (LMGT3)', kleur:'#c0a060', info:'Porsche 911 GT3 R LMGT3 — The Bend Manthey.',
