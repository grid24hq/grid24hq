cat > /mnt/user-data/outputs/WEC.tsx << 'ENDOFFILE'
...
const TEAMS: Team[] = [
  // ── Hypercar ──
  { id:'wec-7',   nr:7,   naam:'Toyota Gazoo Racing',      fabrikant:'Toyota',       carModel:'toyota-gr010',       klasse:'Hypercar', kleur:'#e8002d', info:'Toyota GR010 Hybrid.',
  ...
  { id:'wec-8',   nr:8,   naam:'Toyota Gazoo Racing',      fabrikant:'Toyota',       carModel:'toyota-gr010',       klasse:'Hypercar', kleur:'#e8002d', info:'Toyota GR010 Hybrid.',
  ...
  { id:'wec-007', nr:7,   nrPad:'007', naam:'Aston Martin Aramco',    fabrikant:'Aston Martin', carModel:'aston-martin-valkyrie', klasse:'Hypercar', kleur:'#006b5b', info:'Aston Martin Valkyrie AMR Pro.',
  ...
  { id:'wec-009', nr:9,   nrPad:'009', naam:'Aston Martin Aramco',    fabrikant:'Aston Martin', carModel:'aston-martin-valkyrie', klasse:'Hypercar', kleur:'#006b5b', info:'Aston Martin Valkyrie AMR Pro.',
  ...
  { id:'wec-12',  nr:12,  naam:'Cadillac Racing',          fabrikant:'Cadillac',     carModel:'cadillac',           klasse:'Hypercar', kleur:'#a0001c', info:'Cadillac V-Series.R.',
  ...
  { id:'wec-15',  nr:15,  naam:'BMW M Team WRT',           fabrikant:'BMW',          carModel:'bmwm-hybrid-v8',     klasse:'Hypercar', kleur:'#1c69d4', info:'BMW M Hybrid V8.',
  ...
  { id:'wec-17',  nr:17,  naam:'Genesis X Gran Berlinetta',fabrikant:'Genesis',      carModel:'genesis',            klasse:'Hypercar', kleur:'#c0a020', info:'Genesis X Gran Berlinetta.',
  ...
  { id:'wec-19',  nr:19,  naam:'Genesis X Gran Berlinetta',fabrikant:'Genesis',      carModel:'genesis',            klasse:'Hypercar', kleur:'#c0a020', info:'Genesis X Gran Berlinetta.',
  ...
  { id:'wec-20',  nr:20,  naam:'BMW M Team WRT',           fabrikant:'BMW',          carModel:'bmwm-hybrid-v8',     klasse:'Hypercar', kleur:'#1c69d4', info:'BMW M Hybrid V8.',
  ...
  { id:'wec-35',  nr:35,  naam:'Alpine Endurance Team',    fabrikant:'Alpine',       carModel:'alpine-a424',        klasse:'Hypercar', kleur:'#0093cc', info:'Alpine A424.',
  ...
  { id:'wec-36',  nr:36,  naam:'Alpine Endurance Team',    fabrikant:'Alpine',       carModel:'alpine-a424',        klasse:'Hypercar', kleur:'#0093cc', info:'Alpine A424.',
  ...
  { id:'wec-38',  nr:38,  naam:'Cadillac Racing',          fabrikant:'Cadillac',     carModel:'cadillac',           klasse:'Hypercar', kleur:'#a0001c', info:'Cadillac V-Series.R.',
  ...
  { id:'wec-50',  nr:50,  naam:'Ferrari AF Corse',         fabrikant:'Ferrari',      carModel:'ferrari-499',        klasse:'Hypercar', kleur:'#e8002d', info:'Ferrari 499P.',
  ...
  { id:'wec-51',  nr:51,  naam:'Ferrari AF Corse',         fabrikant:'Ferrari',      carModel:'ferrari-499',        klasse:'Hypercar', kleur:'#e8002d', info:'Ferrari 499P.',
  ...
  { id:'wec-83',  nr:83,  naam:'AF Corse',                 fabrikant:'Ferrari',      carModel:'ferrari-499',        klasse:'Hypercar', kleur:'#e8002d', info:'Ferrari 499P.',
  ...
  { id:'wec-93',  nr:93,  naam:'Peugeot TotalEnergies',    fabrikant:'Peugeot',      carModel:'peugeot-9x8',        klasse:'Hypercar', kleur:'#00aaff', info:'Peugeot 9X8.',
  ...
  { id:'wec-94',  nr:94,  naam:'Peugeot TotalEnergies',    fabrikant:'Peugeot',      carModel:'peugeot-9x8',        klasse:'Hypercar', kleur:'#00aaff', info:'Peugeot 9X8.',
  ...
  { id:'wec-gt3-10', nr:10, naam:'Garage 59',              fabrikant:'McLaren',  carModel:'mclaren-720s',      klasse:'GT3 (LMGT3)', kleur:'#ff8000', info:'McLaren 720S GT3 — Garage 59.',
  ...
  { id:'wec-gt3-21', nr:21, naam:'Iron Lynx',              fabrikant:'Ferrari',  carModel:'ferrari-296-gt3',   klasse:'GT3 (LMGT3)', kleur:'#e8002d', info:'Ferrari 296 GT3 — Iron Lynx.',
  ...
  { id:'wec-gt3-23', nr:23, naam:'Heart of Racing Team',   fabrikant:'Aston Martin', carModel:'aston-martin-gt3', klasse:'GT3 (LMGT3)', kleur:'#006b5b', info:'Aston Martin Vantage GT3 — Heart of Racing.',
  ...
  { id:'wec-gt3-27', nr:27, naam:'Heart of Racing Team',   fabrikant:'Aston Martin', carModel:'aston-martin-gt3', klasse:'GT3 (LMGT3)', kleur:'#006b5b', info:'Aston Martin Vantage GT3 — Heart of Racing.',
  ...
  { id:'wec-gt3-32', nr:32, naam:'Team WRT',               fabrikant:'BMW',      carModel:'bmw-m4-gt3',        klasse:'GT3 (LMGT3)', kleur:'#1c69d4', info:'BMW M4 GT3 Evo — Team WRT.',
  ...
  { id:'wec-gt3-33', nr:33, naam:'Corvette Racing',        fabrikant:'Corvette', carModel:'corvette-z06-gt3',   klasse:'GT3 (LMGT3)', kleur:'#ffcc00', info:'Corvette Z06 GT3.R.',
  ...
  { id:'wec-gt3-34', nr:34, naam:'Racing Team Turkey by TF',fabrikant:'Corvette',carModel:'corvette-z06-gt3-r',  klasse:'GT3 (LMGT3)', kleur:'#ffcc00', info:'Corvette Z06 GT3.R — Racing Team Turkey.',
    drivers:[{id:'charlie-eastwood',naam:'Charlie Eastwood',nationaliteit:'Ierland',vlag:'🇮🇪'},{id:'peter-dempsey',naam:'Peter Dempsey',nationaliteit:'Ierland',vlag:'🇮🇪'},{id:'salih-yoluc',naam:'Salih Yoluc',nationaliteit:'Turkije',vlag:'🇹🇷'}] },
  { id:'wec-gt3-54', nr:54, naam:'Vista AF Corse',         fabrikant:'Ferrari',  carModel:'ferrari-296-gt3',    klasse:'GT3 (LMGT3)', kleur:'#e8002d', info:'Ferrari 296 GT3 — Vista AF Corse.',
  ...
  { id:'wec-gt3-58', nr:58, naam:'United Autosports',      fabrikant:'McLaren',  carModel:'mclaren-720s',       klasse:'GT3 (LMGT3)', kleur:'#ff8000', info:'McLaren 720S GT3 — United Autosports.',
  ...
  { id:'wec-gt3-61', nr:61, naam:'Akkodis ASP',            fabrikant:'Mercedes', carModel:'mercedes',           klasse:'GT3 (LMGT3)', kleur:'#00d2be', info:'Mercedes-AMG GT3 — Akkodis ASP.',
  ...
  { id:'wec-gt3-69', nr:69, naam:'Team WRT',               fabrikant:'BMW',      carModel:'bmw-m4-gt3-spa',     klasse:'GT3 (LMGT3)', kleur:'#1c69d4', info:'BMW M4 GT3 Evo — Team WRT #69.',
  ...
  { id:'wec-gt3-77', nr:77, naam:'Proton Competition',     fabrikant:'Ford',     carModel:'ford-mustang',       klasse:'GT3 (LMGT3)', kleur:'#003e99', info:'Ford Mustang GT3 — Proton Competition.',
  ...
  { id:'wec-gt3-78', nr:78, naam:'Akkodis ASP Team',       fabrikant:'Lexus',    carModel:'lexus-rc-f-lmgt3',   klasse:'GT3 (LMGT3)', kleur:'#e8002d', info:'Lexus RC F LMGT3 — Akkodis ASP.',
  ...
  { id:'wec-gt3-79', nr:79, naam:'Iron Lynx',              fabrikant:'Mercedes', carModel:'mercedes-lmgt3',     klasse:'GT3 (LMGT3)', kleur:'#00d2be', info:'Mercedes-AMG LMGT3 — Iron Lynx.',
  ...
  { id:'wec-gt3-87', nr:87, naam:'Toyota Gazoo Racing',    fabrikant:'Lexus',    carModel:'lexus-rc-f-lmgt3',   klasse:'GT3 (LMGT3)', kleur:'#e8002d', info:'Lexus RC F LMGT3 — Gazoo Racing.',
  ...
  { id:'wec-gt3-88', nr:88, naam:'Proton Competition',     fabrikant:'Ford',     carModel:'ford-mustang',       klasse:'GT3 (LMGT3)', kleur:'#003e99', info:'Ford Mustang GT3 — Proton Competition #88.',
      ...
      <div className="relative w-full max-w-4xl rounded-2xl overflow-hidden flex"
        ...
        <div className="relative flex-shrink-0 flex flex-col" style={{width:240,background:`linear-gradient(180deg,${c}22 0%,#0a0a0a 60%)`,overflowY:'auto',maxHeight:'90vh'}}>
          ...
          <div className="px-5 pb-2">
            <div className="font-head font-black text-5xl leading-none" style={{color:c}}>#{nrStr(team)}</div>
          ...
          <div className="px-4 py-3 space-y-2.5">
            {[{icon:'🏎️',label:'Auto',val:team.carModel.replace(/-/g,' ').replace(/\b\w/g,l=>l.toUpperCase())},{icon:'🏁',label:'Klasse',val:team.klasse},{icon:'🔢',label:'Nummer',val:`#${nrStr(team)}`},{icon:'👥',label:'Rijders',val:`${team.drivers.length} coureurs`}].map(({icon,label,val})=>(
              <div key={label} className="flex items-start gap-2"><span className="text-xs mt-0.5 flex-shrink-0">{icon}</span><div><div className="font-ui text-[9px] uppercase tracking-wider text-white/30">{label}</div><div className="font-ui text-xs text-white/80">{val}</div></div></div>
            ))}
          </div>
            ...
            {tab==='overzicht' && (
              <div className="space-y-5">
                <div className="grid grid-cols-3 gap-3">
                  {[{label:'Team',val:team.naam},{label:'Nummer',val:`#${nrStr(team)}`},{label:'Fabrikant',val:team.fabrikant},{label:'Klasse',val:team.klasse},{label:'Auto',val:team.carModel.split('-').slice(-2).join(' ').toUpperCase()},{label:'Coureurs',val:String(team.drivers.length)}].map(({label,val})=>(
              ...
              <div className="space-y-3">
                {team.drivers.map(d=>(
                  <div key={d.id} className="flex items-center gap-4 rounded-xl p-3" style={{background:'rgba(255,255,255,0.04)',border:`1px solid ${c}20`}}>
                    <div className="flex-shrink-0 rounded-xl overflow-hidden" style={{width:76,height:95,background:'rgba(255,255,255,0.03)'}}>
                      <img src={drvSrc(team,d)} alt={d.naam} style={{width:'100%',height:'100%',objectFit:'cover',objectPosition:'top center'}} onError={e=>{(e.currentTarget as HTMLImageElement).style.opacity='0.08'}}/>
                    </div>
