...
const RIJDER_INFO: Record<string, {
  ...
  norris:     { geboortedatum: '13 nov. 1999', leeftijd: 25, geboorteplaats: 'Bristol, Engeland',    lengte: '1.75 m', debuut: '2019, Australië', wereldtitels: 0, carModel: 'MCL40',   motor: 'Mercedes', chassis: 'MCL40',    banden: 'Pirelli', carOmschrijving: 'De MCL40 is McLarens bolide voor het 2026-seizoen. Met een vernieuwd aerodynamisch pakket en Mercedes power unit.' },
  piastri:    { geboortedatum: '6 apr. 2001',  leeftijd: 24, geboorteplaats: 'Melbourne, Australië', lengte: '1.78 m', debuut: '2023, Bahrein',   wereldtitels: 0, carModel: 'MCL40',   motor: 'Mercedes', chassis: 'MCL40',    banden: 'Pirelli', carOmschrijving: 'De MCL40 is McLarens bolide voor het 2026-seizoen.' },
  verstappen: { geboortedatum: '30 sep. 1997', leeftijd: 27, geboorteplaats: 'Hasselt, België',      lengte: '1.81 m', debuut: '2015, Australië', wereldtitels: 4, carModel: 'RB21',    motor: 'Honda',    chassis: 'RB21',     banden: 'Pirelli', carOmschrijving: 'De RB21 is Red Bulls wapen voor 2026. Ontworpen voor maximale downforce en aerodynamische efficiëntie.' },
  hadjar:     { geboortedatum: '28 sep. 2004', leeftijd: 20, geboorteplaats: 'Évry, Frankrijk',      lengte: '1.71 m', debuut: '2026, Bahrein',   wereldtitels: 0, carModel: 'RB21',    motor: 'Honda',    chassis: 'RB21',     banden: 'Pirelli', carOmschrijving: 'De RB21 is Red Bulls wapen voor 2026.' },
  leclerc:    { geboortedatum: '16 okt. 1997', leeftijd: 27, geboorteplaats: 'Monte Carlo, Monaco',  lengte: '1.80 m', debuut: '2018, Australië', wereldtitels: 0, carModel: 'SF-26',   motor: 'Ferrari',  chassis: 'SF-26',    banden: 'Pirelli', carOmschrijving: 'De SF-26 is Ferraris bolide voor 2026, gebouwd op een nieuw technisch reglement.' },
  hamilton:   { geboortedatum: '7 jan. 1985',  leeftijd: 40, geboorteplaats: 'Stevenage, Engeland',  lengte: '1.74 m', debuut: '2007, Australië', wereldtitels: 7, carModel: 'SF-26',   motor: 'Ferrari',  chassis: 'SF-26',    banden: 'Pirelli', carOmschrijving: 'De SF-26 is Ferraris bolide voor 2026.' },
  russell:    { geboortedatum: '15 feb. 1998', leeftijd: 27, geboorteplaats: 'Kings Lynn, Engeland', lengte: '1.85 m', debuut: '2019, Australië', wereldtitels: 0, carModel: 'W17',     motor: 'Mercedes', chassis: 'W17',      banden: 'Pirelli', carOmschrijving: 'De W17 is Mercedes\' antwoord op de nieuwe technische reglementen voor 2026.' },
  antonelli:  { geboortedatum: '25 jan. 2006', leeftijd: 19, geboorteplaats: 'Bologna, Italië',      lengte: '1.72 m', debuut: '2026, Bahrein',   wereldtitels: 0, carModel: 'W17',     motor: 'Mercedes', chassis: 'W17',      banden: 'Pirelli', carOmschrijving: 'De W17 is Mercedes\' antwoord op de nieuwe technische reglementen.' },
  alonso:     { geboortedatum: '29 jul. 1981', leeftijd: 43, geboorteplaats: 'Oviedo, Spanje',       lengte: '1.71 m', debuut: '2001, Australië', wereldtitels: 2, carModel: 'AMR26',   motor: 'Mercedes', chassis: 'AMR26',    banden: 'Pirelli', carOmschrijving: 'De AMR26 is Aston Martins meest ambitieuze project ooit.' },
  stroll:     { geboortedatum: '29 okt. 1998', leeftijd: 26, geboorteplaats: 'Montréal, Canada',     lengte: '1.82 m', debuut: '2017, Australië', wereldtitels: 0, carModel: 'AMR26',   motor: 'Mercedes', chassis: 'AMR26',    banden: 'Pirelli', carOmschrijving: 'De AMR26 is Aston Martins meest ambitieuze project ooit.' },
  albon:      { geboortedatum: '23 mrt. 1996', leeftijd: 29, geboorteplaats: 'Londen, Engeland',     lengte: '1.86 m', debuut: '2019, Australië', wereldtitels: 0, carModel: 'FW47',    motor: 'Mercedes', chassis: 'FW47',     banden: 'Pirelli', carOmschrijving: 'De FW47 is Williams\' bolide voor 2026.' },
  sainz:      { geboortedatum: '1 sep. 1994',  leeftijd: 30, geboorteplaats: 'Madrid, Spanje',       lengte: '1.78 m', debuut: '2015, Australië', wereldtitels: 0, carModel: 'FW47',    motor: 'Mercedes', chassis: 'FW47',     banden: 'Pirelli', carOmschrijving: 'De FW47 is Williams\' bolide voor 2026.' },
  lawson:     { geboortedatum: '11 feb. 2002', leeftijd: 23, geboorteplaats: 'Hastings, Nieuw-Z.',   lengte: '1.75 m', debuut: '2024, Singapore', wereldtitels: 0, carModel: 'VCARB 02',motor: 'Honda',    chassis: 'VCARB02',  banden: 'Pirelli', carOmschrijving: 'De VCARB02 is Racing Bulls\' wapen voor 2026.' },
  lindblad:   { geboortedatum: '26 sep. 2005', leeftijd: 19, geboorteplaats: 'Sheffield, Engeland',  lengte: '1.73 m', debuut: '2026, Bahrein',   wereldtitels: 0, carModel: 'VCARB 02',motor: 'Honda',    chassis: 'VCARB02',  banden: 'Pirelli', carOmschrijving: 'De VCARB02 is Racing Bulls\' wapen voor 2026.' },
  ocon:       { geboortedatum: '17 sep. 1996', leeftijd: 28, geboorteplaats: 'Évreux, Frankrijk',    lengte: '1.86 m', debuut: '2017, Bahrein',   wereldtitels: 0, carModel: 'VF-26',   motor: 'Ferrari',  chassis: 'VF-26',    banden: 'Pirelli', carOmschrijving: 'De VF-26 is Haas\' bolide voor 2026 met Ferrari power.' },
  bearman:    { geboortedatum: '8 mei 2005',   leeftijd: 20, geboorteplaats: 'Chelmsford, Engeland', lengte: '1.80 m', debuut: '2025, Bahrein',   wereldtitels: 0, carModel: 'VF-26',   motor: 'Ferrari',  chassis: 'VF-26',    banden: 'Pirelli', carOmschrijving: 'De VF-26 is Haas\' bolide voor 2026.' },
  hulkenberg: { geboortedatum: '19 aug. 1987', leeftijd: 37, geboorteplaats: 'Emmerich, Duitsland',  lengte: '1.84 m', debuut: '2010, Bahrein',   wereldtitels: 0, carModel: 'C45',     motor: 'Audi',     chassis: 'C45',      banden: 'Pirelli', carOmschrijving: 'De C45 is de eerste Audi-bolide in de Formule 1.' },
  bortoleto:  { geboortedatum: '14 okt. 2004', leeftijd: 20, geboorteplaats: 'São Paulo, Brazilië',  lengte: '1.73 m', debuut: '2026, Bahrein',   wereldtitels: 0, carModel: 'C45',     motor: 'Audi',     chassis: 'C45',      banden: 'Pirelli', carOmschrijving: 'De C45 is de eerste Audi-bolide in de Formule 1.' },
  gasly:      { geboortedatum: '7 feb. 1996',  leeftijd: 29, geboorteplaats: 'Rouen, Frankrijk',     lengte: '1.77 m', debuut: '2017, Maleisië',  wereldtitels: 0, carModel: 'A526',    motor: 'Renault',  chassis: 'A526',     banden: 'Pirelli', carOmschrijving: 'De A526 is Alpine\'s bolide voor 2026 met Renault power.' },
  colapinto:  { geboortedatum: '27 mei 2003',  leeftijd: 22, geboorteplaats: 'Pilar, Argentinië',    lengte: '1.76 m', debuut: '2024, Singapore', wereldtitels: 0, carModel: 'A526',    motor: 'Renault',  chassis: 'A526',     banden: 'Pirelli', carOmschrijving: 'De A526 is Alpine\'s bolide voor 2026.' },
  perez:      { geboortedatum: '26 jan. 1990', leeftijd: 35, geboorteplaats: 'Guadalajara, Mexico',  lengte: '1.73 m', debuut: '2011, Australië', wereldtitels: 0, carModel: 'CF-1',    motor: 'GM/Cadillac', chassis: 'CF-1', banden: 'Pirelli', carOmschrijving: 'De CF-1 is Cadillacs debuutbolide in de Formule 1.' },
  bottas:     { geboortedatum: '28 aug. 1989', leeftijd: 35, geboorteplaats: 'Nastola, Finland',     lengte: '1.73 m', debuut: '2013, Australië', wereldtitels: 0, carModel: 'CF-1',    motor: 'GM/Cadillac', chassis: 'CF-1', banden: 'Pirelli', carOmschrijving: 'De CF-1 is Cadillacs debuutbolide in de Formule 1.' },
}
